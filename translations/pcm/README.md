...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T17:52:56+00:00",
...
**Time Commitment**: Dis workshop fit finish online, no need local setup. E go take 2 minutes to set up di environment, and di samples fit take 1-3 hours to explore, depend how deep you wan go.
...
- **Prompt Engineering**: How to get better responses from AI models
...
- **Function Calling**: Add custom tools and plugins to AI
- **[→ Start Chapter 3](./03-CoreGenerativeAITechniques/README.md)**

### **Chapter 4: Practical Applications & Projects**
- **Pet Story Generator** (`petstory/`): Create stories with GitHub Models
- **Foundry Local Demo** (`foundrylocal/`): Use local AI model with OpenAI Java SDK
...
- **GitHub Models Safety**: Test di built-in content filtering and safety mechanisms (hard blocks and soft refusals)
- **Responsible AI Demo**: Example wey show how modern AI safety systems dey work
...
If e be say you dey stuck or you get any kweshon about how to build AI apps. You fit join oda learners and developers wey sabi well well to talk about MCP. Na one kind community wey dey support people, dem dey welcome kweshons and dem dey share knowledge free.

[![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)

If you get feedback about product or you dey see error when you dey build, go check:
