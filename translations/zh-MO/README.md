# Generative AI 初學者指南 - Java 版本
[![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)

![Generative AI 初學者指南 - Java 版本](../../translated_images/zh-MO/beg-genai-series.8b48be9951cc574c.webp)

**時間承諾**：整個工作坊可以在線上完成，無需本地設置。環境設置約需 2 分鐘，瀏覽範例視探索深度約需 1-3 小時。

> **快速開始** 

1. 將此儲存庫分叉到你的 GitHub 帳戶
2. 點選 **Code** → **Codespaces** 標籤 → **...** → **新建選項**
3. 使用預設值 – 此動作會選擇為本課程創建的開發容器
...
> **偏好本地克隆？**
>
> 此儲存庫包含超過 50 種語言翻譯，顯著增加了下載大小。若想不帶翻譯克隆，請使用稀疏檢出：
>
> **Linux / macOS (Bash)**
> ```bash
...
> git sparse-checkout set --no-cone "/*" "!translations" "!translated_images"
> ```
> 這樣可讓你快速取得完成課程所需的所有內容，並大幅縮短下載時間。


## 多語言支援

### 透過 GitHub Action 支援（自動並時刻更新）
...
### **第一章：生成式 AI 簡介**
- **核心概念**：理解大型語言模型、標記、嵌入和 AI 能力
- **Java AI 生態系統**：Spring AI 和 OpenAI SDK 概述
- **模型上下文協議**：介紹 MCP 及其在 AI 代理通訊中的角色
- **實務應用**：包括聊天機器人和內容生成的現實場景
- **[→ 開始第一章](./01-IntroToGenAI/README.md)**

### **第二章：開發環境設置**
- **多提供者配置**：設定 GitHub Models、Azure OpenAI 及 OpenAI Java SDK 整合
...
- **MCP 計算服務**（`calculator/`）：使用 Spring AI 的基本模型上下文協議實作
- **[→ 開始第四章](./04-PracticalSamples/README.md)**

### **第五章：負責任的 AI 開發**
- **GitHub Models 安全性**：測試內建內容過濾及安全機制（硬性阻擋與軟性拒絕）
- **負責任 AI 示範**：實作展示當代 AI 安全系統的運作方式
- **最佳實踐**：倫理 AI 開發與部署的核心指導方針
...
如果你遇到困難或對建立 AI 應用程式有任何問題，加入其他學習者和經驗豐富的開發者，一同參與 MCP 的討論。這是一個支持性的社群，歡迎提出問題並自由分享知識。
...
**免責聲明**：
本文件乃使用 AI 翻譯服務 [Co-op Translator](https://github.com/Azure/co-op-translator) 所翻譯。雖然我們致力於確保準確性，但請注意，自動翻譯可能包含錯誤或不準確之處。原文文件的本土語言版本應視為權威來源。對於重要資訊，建議使用專業人工翻譯。我們不對因使用本翻譯所產生的任何誤解或誤釋承擔責任。
