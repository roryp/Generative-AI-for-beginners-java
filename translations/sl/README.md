# Generativna AI za začetnike - izdaja za Javo
[![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)

![Generativna AI za začetnike - izdaja za Javo](../../translated_images/sl/beg-genai-series.8b48be9951cc574c.webp)

**Časovni vložek**: Celoten delavnico lahko opravite preko spleta brez lokalne namestitve. Priprava okolja traja 2 minuti, raziskovanje vzorcev pa zahteva 1-3 ure, odvisno od globine raziskovanja.

> **Hiter začetek** 

1. Razvejite ta repozitorij v svoj GitHub račun
2. Kliknite **Koda** → zavihek **Codespaces** → **...** → **Novo z možnostmi...**
3. Uporabite privzete nastavitve – to bo izbralo razvojno vsebnik, ustvarjen za ta tečaj
4. Kliknite **Ustvari codespace**
5. Počakajte približno 2 minuti, da bo okolje pripravljeno
6. Pojdite naravnost na [Prvi primer](./02-SetupDevEnvironment/README.md#step-2-create-a-github-personal-access-token)
...
- **Protokol za kontekst modela**: Uvod v MCP in njegova vloga pri komunikaciji AI agentov
- **Praktične uporabe**: Realni scenariji, vključno s klepetalniki in ustvarjanjem vsebine
- **[→ Začni poglavje 1](./01-IntroToGenAI/README.md)**

### **Poglavje 2: Namestitev razvojnega okolja**
...
- **GitHub modeli**: Brezplačni dostop do AI modelov za prototipiranje in učenje (ni potrebna kreditna kartica)
- **Razvojna orodja**: Nastavitve Docker vsebnikov, VS Code in GitHub Codespaces
- **[→ Začni poglavje 2](./02-SetupDevEnvironment/README.md)**

### **Poglavje 3: Osnovne tehnike generativne AI**
- **Inženiring ukazov**: Tehnike za optimalne odzive AI modelov
- **Vdelave in vektorske operacije**: Izvedite semantično iskanje in ujemanje podobnosti
- **Pridobivanje podpore (RAG)**: Povežite AI z vašimi lastnimi podatkovnimi viri
...
- **Generator zgodb za hišne ljubljenčke** (`petstory/`): Ustvarjalno generiranje vsebine z GitHub modeli
- **Foundry lokalna demonstracija** (`foundrylocal/`): Lokalna integracija AI modela z OpenAI Java SDK
- **Storitev kalkulatorja MCP** (`calculator/`): Osnovna implementacija protokola Model Context z Spring AI
- **[→ Začni poglavje 4](./04-PracticalSamples/README.md)**

### **Poglavje 5: Odgovoren razvoj AI**
- **Varnost GitHub modelov**: Preizkušajte vgrajeno filtriranje vsebine in varnostne mehanizme (trde blokade in mehki odkloni)
- **Demo odgovorne AI**: Praktičen primer, ki prikazuje, kako delujejo moderni varnostni sistemi v AI
...
Če se zataknete ali imate kakršnakoli vprašanja glede gradnje AI aplikacij. Pridružite se ostalim učencem in izkušenim razvijalcem v razpravah o MCP. To je podporna skupnost, kjer so vprašanja dobrodošla in znanje se prosto deli.
