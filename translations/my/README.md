...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-17T14:48:35+00:00",
...
3. ပုံမှန်တန်ဖိုးများကို အသုံးပြုပါ – ဤသည်က သင်တန်းအတွက် ဖန်တီးထားသော Development container ကို ရွေးချယ်မည်ဖြစ်သည်
4. **Create codespace** ကိုနှိပ်ပါ
5. ပတ်ဝန်းကျင် ပြင်ဆင်ပြီးရန် ~၂ မိနစ် စောင့်ပါ
6. တိုက်ရိုက် [ပထမဥပမာ](./02-SetupDevEnvironment/README.md#step-2-create-a-github-personal-access-token) သို့ ခုန်ပါ
...
### **အခန်း ၁: Generative AI အကြောင်းအရာမိတ်ဆက်ခြင်း**
- **အဓိကအယူအဆများ**: ကြီးမားသောဘာသာစကားမော်ဒယ်များ၊ token များ၊ embedding များနှင့် AI စွမ်းရည်များကို နားလည်ခြင်း
- **Java AI ပတ်ဝန်းကျင်**: Spring AI နှင့် OpenAI SDK များအကြောင်းအနှစ်ချုပ်
- **Model Context Protocol**: MCP နှင့် AI အေးဂျင့်ဆက်သွယ်မှုတွင် ၎င်း၏ အခန်းကဏ္ဍ မိတ်ဆက်ခြင်း
- **လက်တွေ့အသုံးချမှုများ**: စကားပြောအေးဂျင့်များနှင့် အကြောင်းအရာဖန်တီးခြင်း အပါအဝင် အမှန်တကယ်ဖြစ်ပေါ်သော အခြေအနေများ
- **[→ အခန်း ၁ စတင်ရန်](./01-IntroToGenAI/README.md)**

### **အခန်း ၂: ဖွံ့ဖြိုးရေးပတ်ဝန်းကျင် ဆက်တင်ခြင်း**
- **အမျိုးမျိုးသော ပံ့ပိုးသူများ ဖွဲ့စည်းခြင်း**: GitHub Models, Azure OpenAI နှင့် OpenAI Java SDK ပေါင်းစပ်ခြင်း
- **Spring Boot + Spring AI**: စီးပွားရေး AI အက်ပလီကေးရှင်း ဖွံ့ဖြိုးရေးအတွက် အကောင်းဆုံးလေ့လာမှုများ
- **GitHub Models**: prototype ဖန်တီးခြင်းနှင့် သင်ယူခြင်းအတွက် အခမဲ့ AI မော်ဒယ်များ (credit card မလိုအပ်)
...
- **Embedding နှင့် Vector လုပ်ဆောင်ချက်များ**: semantic ရှာဖွေရေးနှင့် ဆင်တူမှုကို တည်ဆောက်ခြင်း
...
- **GitHub Models လုံခြုံရေး**: အတွင်းပိုင်း အကြောင်းအရာစစ်ထုတ်ခြင်းနှင့် လုံခြုံရေးစနစ်များ (ခက်ခဲသောတားမြစ်မှုများနှင့် နူးညံ့သောငြင်းပယ်မှုများ) စမ်းသပ်ခြင်း
- **တာဝန်ရှိသော AI ဒေမို**: ခေတ်မီ AI လုံခြုံရေးစနစ်များ လက်တွေ့အလုပ်လုပ်ပုံကို ပြသသော လက်တွေ့ဥပမာ
...
AI အက်ပ်များ တည်ဆောက်ရာတွင် အခက်အခဲများရှိပါက သို့မဟုတ် မေးခွန်းများရှိပါက MCP အကြောင်း ဆွေးနွေးမှုများတွင် အတူတကွ သင်ယူနေသူများနှင့် အတွေ့အကြုံရှိသူများနှင့် ပူးပေါင်းပါဝင်နိုင်သည်။ ၎င်းသည် မေးခွန်းများကို ကြိုဆိုပြီး အသိပညာများကို လွတ်လပ်စွာ မျှဝေသော ပံ့ပိုးမှုရှိသော အသိုင်းအဝိုင်းတစ်ခုဖြစ်သည်။
