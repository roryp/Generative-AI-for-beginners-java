...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-23T12:09:49+00:00",
  "source_file": "02-SetupDevEnvironment/README.md",
  "language_code": "ne"
}
-->
# जाभाका लागि जेनेरेटिभ एआईको विकास वातावरण सेटअप गर्नुहोस्

> **छिटो सुरु गर्नुहोस्**: क्लाउडमा २ मिनेटमा कोड लेख्नुहोस् - [GitHub Codespaces सेटअप](../../../02-SetupDevEnvironment) मा जानुहोस् - कुनै स्थानीय इन्स्टलेशन आवश्यक छैन र GitHub मोडेलहरू प्रयोग गर्दछ!

> **Azure OpenAI मा रुचि छ?**, नयाँ Azure OpenAI स्रोत सिर्जना गर्ने चरणहरूको लागि हाम्रो [Azure OpenAI सेटअप गाइड](getting-started-azure-openai.md) हेर्नुहोस्।

## तपाईंले के सिक्नुहुनेछ

- एआई एप्लिकेसनहरूको लागि जाभा विकास वातावरण सेटअप गर्नुहोस्
- आफ्नो मनपर्ने विकास वातावरण चयन र कन्फिगर गर्नुहोस् (Codespaces सहित क्लाउड-प्रथम, स्थानीय डिभ कन्टेनर, वा पूर्ण स्थानीय सेटअप)
...
- [चरण १: आफ्नो विकास वातावरण सेटअप गर्नुहोस्](../../../02-SetupDevEnvironment)
  ...
  - [विकल्प C: आफ्नो विद्यमान स्थानीय इन्स्टलेशन प्रयोग गर्नुहोस्](../../../02-SetupDevEnvironment)
...
हामीले यस जेनेरेटिभ एआई जाभा कोर्सको लागि आवश्यक सबै उपकरणहरू सहित पूर्व-कन्फिगर गरिएको विकास कन्टेनर सिर्जना गरेका छौं। आफ्नो मनपर्ने विकास विधि चयन गर्नुहोस्:
...
3. डिफल्टहरू प्रयोग गर्नुहोस् – यसले **Generative AI Java Development Environment** कस्टम डिभ कन्टेनर चयन गर्नेछ।
...
> - व्यक्तिगत खाताहरूको लागि प्रति महिना ६० घण्टा निःशुल्क
...
#### विकल्प C: आफ्नो विद्यमान स्थानीय इन्स्टलेशन प्रयोग गर्नुहोस्
...
<img src="./images/image-2.png" alt="स्क्रिनशट: स्थानीय डिभ कन्टेनर उदाहरण सिर्जना गरिएको" width="50%">
...
2. बाँया साइडबारमा, **Developer settings** क्लिक गर्नुहोस् (सामान्यतया तलतिर)।
...
8. "Repository access" अन्तर्गत, तपाईंले प्रयोग गर्न चाहेको रिपोजिटरीहरू चयन गर्नुहोस् (वा "All repositories" यदि आवश्यक छ भने)।
...
11. **अब आफ्नो टोकन प्रतिलिपि गर्नुहोस् र सुरक्षित गर्नुहोस्** – तपाईंले यसलाई फेरि देख्न सक्नुहुन्न!

> **सुरक्षा टिप**: न्यूनतम आवश्यक स्कोप र छोटो व्यावहारिक समाप्ति समय प्रयोग गर्नुहोस्।

## चरण ३: GitHub मोडेलहरूको उदाहरणसँग आफ्नो सेटअप परीक्षण गर्नुहोस्

जब तपाईंको विकास वातावरण तयार हुन्छ, GitHub मोडेलहरूको उदाहरण एप्लिकेसन परीक्षण गरौं [`02-SetupDevEnvironment/src/github-models`](../../../02-SetupDevEnvironment/src/github-models) मा।
...
पहिला, हामीले के चलायौं बुझौं। `src/github-models` अन्तर्गतको उदाहरणले OpenAI Java SDK प्रयोग गरेर GitHub मोडेलहरूसँग जडान गर्दछ:

**यो कोडले के गर्छ:**
- **जडान गर्दछ** GitHub मोडेलहरूसँग तपाईंको व्यक्तिगत पहुँच टोकन प्रयोग गरेर
- एआई मोडेललाई "Say Hello World!" सन्देश **पठाउँछ**
- एआईको प्रतिक्रिया **प्राप्त गर्दछ** र प्रदर्शन गर्दछ
- तपाईंको सेटअप सही रूपमा काम गरिरहेको छ भनी **प्रमाणित गर्दछ**
...
- **जाभा विकास वातावरण सेटअप गर्नुभयो** Codespaces, डिभ कन्टेनर, वा स्थानीय इन्स्टलेशन प्रयोग गरेर
- **GitHub मोडेलहरूसँग जडान गर्नुभयो** OpenAI Java SDK प्रयोग गरेर निःशुल्क एआई विकास पहुँचको लागि
- **एकीकृत परीक्षण गर्नुभयो** काम गर्ने उदाहरण एप्लिकेसन प्रयोग गरेर जसले एआई मोडेलहरूसँग संवाद गर्दछ

## अगाडि के गर्ने

[अध्याय ३: कोर जेनेरेटिभ एआई प्रविधिहरू](../03-CoreGenerativeAITechniques/README.md)
...
- **टोकन काम गरिरहेको छैन?** 
  ...
  - टोकन सही रूपमा वातावरण चरको रूपमा सेट गरिएको छ भनी प्रमाणित गर्नुहोस्।
  - तपाईंको टोकनसँग सही अनुमति छ भनी जाँच गर्नुहोस् (Models: Read and write)।

- **Maven फेला परेन?** 
  - यदि डिभ कन्टेनर/Codespaces प्रयोग गरिरहेको छ भने Maven पूर्व-इन्स्टल गरिएको हुनुपर्छ।
  - स्थानीय सेटअपको लागि, सुनिश्चित गर्नुहोस् कि Java 21+ र Maven 3.9+ इन्स्टल गरिएको छ।
  - `mvn --version` चलाएर इन्स्टलेशन प्रमाणित गर्नुहोस्।

- **जडान समस्या?** 
  - आफ्नो इन्टरनेट जाँच गर्नुहोस्।
  - GitHub तपाईंको नेटवर्कबाट पहुँचयोग्य छ भनी प्रमाणित गर्नुहोस्।
...
> **मद्दत चाहिन्छ?**: अझै समस्या छ? रिपोजिटरीमा समस्या खोल्नुहोस्, हामी तपाईंलाई मद्दत गर्नेछौं।
