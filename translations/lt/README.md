...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-24T09:15:33+00:00",
  "source_file": "README.md",
  "language_code": "lt"
}
-->
# Generatyvinė dirbtinio intelekto technologija pradedantiesiems - Java leidimas
[![Microsoft Azure AI Foundry Discord](https://dcbadge.limes.pink/api/server/ByRwuEEgH4)](https://discord.com/invite/ByRwuEEgH4)

![Generatyvinė dirbtinio intelekto technologija pradedantiesiems - Java leidimas](../../translated_images/beg-genai-series.8b48be9951cc574c25f8a3accba949bfd03c2f008e2c613283a1b47316fbee68.lt.png)

**Laiko sąnaudos**: Visą seminarą galima baigti internetu be vietinio nustatymo. Aplinkos paruošimas užtrunka 2 minutes, o pavyzdžių tyrinėjimas gali užtrukti nuo 1 iki 3 valandų, priklausomai nuo tyrinėjimo gylio.
...
- **GitHub modeliai**: Nemokama AI modelių prieiga prototipų kūrimui ir mokymuisi (nereikia kredito kortelės)
...
### **3 skyrius: Pagrindinės generatyvinio dirbtinio intelekto technikos**
- **Promptų inžinerija**: Technikos optimaliems AI modelio atsakymams gauti
...
- **Gyvūnų istorijų generatorius** (`petstory/`): Kūrybinis turinio generavimas naudojant GitHub modelius
- **Foundry vietinis demonstravimas** (`foundrylocal/`): Vietinė AI modelio integracija su OpenAI Java SDK
...
### **5 skyrius: Atsakingas AI kūrimas**
...
- **Atsakingo AI demonstracija**: Praktinis pavyzdys, kaip veikia šiuolaikinės AI saugumo sistemos
- **Geriausios praktikos**: Esminės gairės etiniam AI kūrimui ir diegimui
...
[![Generatyvinis AI pradedantiesiems](https://img.shields.io/badge/Generatyvinis%20AI%20pradedantiesiems-8B5CF6?style=for-the-badge&labelColor=E5E7EB&color=8B5CF6)](https://github.com/microsoft/generative-ai-for-beginners?WT.mc_id=academic-105485-koreyst)
[![Generatyvinis AI (.NET)](https://img.shields.io/badge/Generatyvinis%20AI%20(.NET)-9333EA?style=for-the-badge&labelColor=E5E7EB&color=9333EA)](https://github.com/microsoft/Generative-AI-for-beginners-dotnet?WT.mc_id=academic-105485-koreyst)
[![Generatyvinis AI (Java)](https://img.shields.io/badge/Generatyvinis%20AI%20(Java)-C084FC?style=for-the-badge&labelColor=E5E7EB&color=C084FC)](https://github.com/microsoft/generative-ai-for-beginners-java?WT.mc_id=academic-105485-koreyst)
[![Generatyvinis AI (JavaScript)](https://img.shields.io/badge/Generatyvinis%20AI%20(JavaScript)-E879F9?style=for-the-badge&labelColor=E5E7EB&color=E879F9)](https://github.com/microsoft/generative-ai-with-javascript?WT.mc_id=academic-105485-koreyst)
