...
>
> Repositori ini menyertakan 50+ terjemahan bahasa yang secara signifikan meningkatkan ukuran unduhan. Untuk clone tanpa terjemahan, gunakan sparse checkout:
> ```bash
> git clone --filter=blob:none --sparse https://github.com/microsoft/Generative-AI-for-beginners-java.git
> cd Generative-AI-for-beginners-java
> git sparse-checkout set --no-cone '/*' '!translations' '!translated_images'
> ```
> Ini memberi Anda semua yang diperlukan untuk menyelesaikan kursus dengan unduhan jauh lebih cepat.
...
- **Ekosistem AI Java**: Tinjauan Spring AI dan OpenAI SDK
- **Protokol Konteks Model**: Pengenalan MCP dan perannya dalam komunikasi agen AI
- **Aplikasi Praktis**: Skenario nyata termasuk chatbot dan pembuatan konten
...
- **Prompt Engineering**: Teknik untuk respon model AI yang optimal
...
- **Keamanan GitHub Models**: Uji penyaringan konten bawaan dan mekanisme keamanan (blokk keras dan penolakan lunak)
- **Demo AI Bertanggung Jawab**: Contoh praktik langsung menunjukkan cara kerja sistem keamanan AI modern
...
**Penafian**:  
Dokumen ini telah diterjemahkan menggunakan layanan terjemahan AI [Co-op Translator](https://github.com/Azure/co-op-translator). Meskipun kami berupaya memberikan terjemahan yang akurat, harap diketahui bahwa terjemahan otomatis mungkin mengandung kesalahan atau ketidaktepatan. Dokumen asli dalam bahasa aslinya harus dianggap sebagai sumber yang otoritatif. Untuk informasi penting, disarankan menggunakan terjemahan profesional oleh penerjemah manusia. Kami tidak bertanggung jawab atas kesalahpahaman atau salah tafsir yang timbul dari penggunaan terjemahan ini.
