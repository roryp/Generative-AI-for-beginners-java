...
**Komitmen Waktu**: Seluruh workshop dapat diselesaikan secara online tanpa pengaturan lokal. Pengaturan lingkungan memakan waktu 2 menit, dengan eksplorasi contoh membutuhkan 1-3 jam tergantung kedalaman eksplorasi.
...
>
> Repositori ini mencakup lebih dari 50 bahasa terjemahan yang secara signifikan menambah ukuran unduhan. Untuk clone tanpa terjemahan, gunakan sparse checkout:
>
> **Linux / macOS (Bash)**
> ```bash
...
- **Aplikasi Praktis**: Skenario dunia nyata termasuk chatbot dan generasi konten
...
- **Spring Boot + Spring AI**: Praktik terbaik pengembangan aplikasi AI perusahaan
...
- **Prompt Engineering**: Teknik respons optimal model AI
- **Embeddings & Operasi Vektor**: Terapkan pencarian semantik dan pencocokan kemiripan
...
- **Generator Cerita Hewan Peliharaan** (`petstory/`): Generasi konten kreatif dengan GitHub Models
...
- **Demo AI Bertanggung Jawab**: Contoh langsung menunjukkan cara kerja sistem keamanan AI modern secara praktis
- **Praktik Terbaik**: Pedoman penting untuk pengembangan dan penerapan AI etis
...
Jika Anda mengalami kesulitan atau memiliki pertanyaan tentang membangun aplikasi AI. Bergabunglah dengan sesama pelajar dan pengembang berpengalaman dalam diskusi tentang MCP. Ini adalah komunitas yang mendukung di mana pertanyaan disambut dan pengetahuan dibagikan dengan bebas.
...
**Penafian**:  
Dokumen ini telah diterjemahkan menggunakan layanan terjemahan AI [Co-op Translator](https://github.com/Azure/co-op-translator). Meskipun kami berupaya untuk mencapai akurasi, harap diketahui bahwa terjemahan otomatis dapat mengandung kesalahan atau ketidakakuratan. Dokumen asli dalam bahasa aslinya harus dianggap sebagai sumber yang sahih. Untuk informasi penting, disarankan menggunakan jasa terjemahan profesional oleh manusia. Kami tidak bertanggung jawab atas kesalahpahaman atau penafsiran yang keliru yang timbul dari penggunaan terjemahan ini.
