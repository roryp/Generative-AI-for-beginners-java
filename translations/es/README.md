...
>
> Este repositorio incluye más de 50 traducciones que aumentan significativamente el tamaño de la descarga. Para clonar sin traducciones, usa checkout esparcido:
> ```bash
...
- **Ecosistema de IA en Java**: Panorama general de Spring AI y SDK de OpenAI
- **Protocolo de Contexto del Modelo**: Introducción a MCP y su papel en la comunicación de agentes IA
...
- **Configuración Multi-Proveedor**: Configura GitHub Models, Azure OpenAI y SDK Java de OpenAI
...
- **Embeddings y Operaciones Vectoriales**: Implementar búsqueda semántica y emparejamiento por similitud
...
- **Demo Local Foundry** (`foundrylocal/`): Integración local de modelos IA con SDK Java de OpenAI
...
- **Seguridad en GitHub Models**: Prueba filtros de contenido y mecanismos de seguridad integrados (bloqueos estrictos y rechazos suaves)
