...
**Compromiso de tiempo**: El taller completo se puede completar en línea sin configuración local. La configuración del entorno toma 2 minutos, y explorar los ejemplos requiere de 1 a 3 horas dependiendo de la profundidad de la exploración.
...
>
> Este repositorio incluye más de 50 traducciones de idiomas lo que incrementa significativamente el tamaño de descarga. Para clonar sin las traducciones, usa la extracción dispersa:
> ```bash
...
- **Conceptos Básicos**: Entendiendo Modelos de Lenguaje Grandes, tokens, incrustaciones y capacidades de IA
- **Ecosistema de IA en Java**: Resumen de Spring AI y SDKs OpenAI
- **Protocolo de Contexto de Modelo**: Introducción a MCP y su rol en la comunicación de agentes IA
...
- **Configuración Multi-Proveedor**: Configura GitHub Models, Azure OpenAI e integraciones del SDK Java OpenAI
- **Spring Boot + Spring AI**: Mejores prácticas para desarrollo de aplicaciones IA empresariales
- **GitHub Models**: Acceso gratuito a modelos IA para prototipos y aprendizaje (sin tarjeta de crédito)
...
- **Ingeniería de Prompts**: Técnicas para respuestas óptimas del modelo IA
- **Incrustaciones & Operaciones Vectoriales**: Implementa búsqueda semántica y comparación de similitud
- **Generación Aumentada por Recuperación (RAG)**: Combina IA con tus propias fuentes de datos
- **Llamadas a Funciones**: Extiende capacidades IA con herramientas y plugins personalizados
...
- **Demo Local Foundry** (`foundrylocal/`): Integración local de modelos IA con SDK Java OpenAI
...
- **Seguridad en GitHub Models**: Prueba filtros de contenido integrados y mecanismos de seguridad (bloqueos duros y rechazos suaves)
...
Si tienes comentarios sobre el producto o encuentras errores durante la creación, visita:
