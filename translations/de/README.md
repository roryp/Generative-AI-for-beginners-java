...
**Zeitaufwand**: Der gesamte Workshop kann online ohne lokale Einrichtung absolviert werden. Die Einrichtung der Umgebung dauert 2 Minuten, das Erkunden der Beispiele erfordert je nach Tiefgang 1–3 Stunden.

> **Schnelleinsteiger** 

1. Forke dieses Repository in deinem GitHub-Konto
2. Klicke auf **Code** → **Codespaces** Tab → **...** → **Neu mit Optionen...**
3. Verwende die Vorgaben – dies wählt den für diesen Kurs erstellten Development Container aus
...
> **Bevorzugst du lokales Klonen?**
>
> Dieses Repository beinhaltet über 50 Sprachübersetzungen, was die Downloadgröße stark erhöht. Um ohne Übersetzungen zu klonen, verwende Sparse Checkout:
>
> **Linux / macOS (Bash)**
> ```bash
...
> git sparse-checkout set --no-cone "/*" "!translations" "!translated_images"
> ```
> So erhältst du alles, was du für den Kurs brauchst, mit einem deutlich schnelleren Download.
...
- **Modell-Kontext-Protokoll**: Einführung in MCP und seine Rolle bei der Kommunikation von KI-Agenten
- **Praktische Anwendungen**: Anwendungsbeispiele aus der Praxis wie Chatbots und Inhaltserstellung
...
- **Spring Boot + Spring AI**: Best Practices für die Entwicklung von KI-Anwendungen in Unternehmen
- **GitHub Models**: Kostenloser KI-Modellzugang zum Prototypenbau und Lernen (keine Kreditkarte erforderlich)
...
- **Embeddings & Vektoroperationen**: Umsetzung semantischer Suche und Ähnlichkeitsabgleich
...
- **Haustiergeschichten-Generator** (`petstory/`): Kreative Inhaltserstellung mit GitHub Models
- **Foundry Local Demo** (`foundrylocal/`): Lokale KI-Modell-Integration mit OpenAI Java SDK
- **MCP Rechner-Service** (`calculator/`): Grundlegende Modell-Kontext-Protokoll-Implementierung mit Spring AI
- **[→ Starte Kapitel 4](./04-PracticalSamples/README.md)**

### **Kapitel 5: Verantwortungsvolle KI-Entwicklung**
- **GitHub Models Sicherheit**: Test von eingebauten Inhaltsfiltern und Sicherheitsmechanismen (harte Sperren und weiche Ablehnungen)
- **Demonstration verantwortungsbewusster KI**: Praxisbeispiel, das zeigt, wie moderne KI-Sicherheitssysteme arbeiten
...
Falls du nicht weiterkommst oder Fragen zum Erstellen von KI-Anwendungen hast. Trete mit anderen Lernenden und erfahrenen Entwicklern in den Diskussionen über MCP in Kontakt. Es ist eine unterstützende Gemeinschaft, in der Fragen willkommen sind und Wissen frei geteilt wird.
