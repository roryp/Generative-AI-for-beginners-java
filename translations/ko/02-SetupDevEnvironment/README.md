...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-21T16:17:17+00:00",
...
1. 이 저장소를 GitHub 계정으로 포크하세요.
   > **참고**: 기본 설정을 수정하려면 [Dev 컨테이너 구성](../../../.devcontainer/devcontainer.json)을 확인하세요.
...
먼저 실행할 내용을 이해해 봅시다. 이 예제는 OpenAI Java SDK를 사용하여 GitHub 모델에 연결합니다:
