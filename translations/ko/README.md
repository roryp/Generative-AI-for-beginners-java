...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T17:03:51+00:00",
...
**소요 시간**: 이 워크숍은 로컬 설정 없이 온라인에서 완료할 수 있습니다. 환경 설정은 2분이 소요되며, 샘플 탐색은 탐구 깊이에 따라 1~3시간이 걸립니다.
...
AI 앱을 개발하다가 막히거나 질문이 생기셨나요? 다른 학습자들과 경험 많은 개발자들이 MCP에 대해 논의하는 커뮤니티에 참여하세요. 이곳은 질문을 환영하며 지식을 자유롭게 공유하는 지원적인 커뮤니티입니다.

[![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)

제품 피드백을 남기거나 개발 중 오류가 발생했다면 아래를 방문하세요:
