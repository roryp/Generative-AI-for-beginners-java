...
**소요 시간**: 전체 워크숍은 로컬 설정 없이 온라인으로 완료할 수 있습니다. 환경 설정은 2분, 샘플 탐색은 탐색 깊이에 따라 1~3시간이 소요됩니다.

> **빠른 시작**

1. 이 저장소를 자신의 GitHub 계정으로 포크합니다.
2. **Code** → **Codespaces** 탭 → **...** → **New with options...**을 클릭합니다.
3. 기본값을 사용합니다 – 이 과정에 맞는 개발 컨테이너가 선택됩니다.
4. **Create codespace**를 클릭합니다.
5. 환경이 준비될 때까지 약 2분 기다립니다.
...
- **GitHub Models**: 프로토타입 및 학습용 무료 AI 모델 액세스 (신용카드 필요 없음)
...
- **함수 호출**: 맞춤 도구와 플러그인으로 AI 기능 확장
- **[→ 3장 시작](./03-CoreGenerativeAITechniques/README.md)**

### **4장: 실용 응용 및 프로젝트**
- **애완동물 이야기 생성기** (`petstory/`): GitHub Models를 활용한 창의적 콘텐츠 생성
...
### **5장: 책임 있는 AI 개발**
- **GitHub Models 안전성**: 내장 콘텐츠 필터링 및 안전 기능 테스트 (강제 차단 및 부드러운 거부)
- **책임 있는 AI 데모**: 최신 AI 안전 시스템의 실제 작동 예시
...
AI 앱을 만드는 데 막히거나 질문이 있을 때는 MCP에 대해 함께 배우고 경험이 풍부한 개발자들과 토론에 참여하세요. 질문이 환영받고 지식이 자유롭게 공유되는 지원 커뮤니티입니다.
...
**면책 조항**:  
이 문서는 AI 번역 서비스 [Co-op Translator](https://github.com/Azure/co-op-translator)를 사용하여 번역되었습니다. 정확성을 위해 최선을 다하고 있으나, 자동 번역에는 오류나 부정확한 부분이 있을 수 있음을 유의해 주시기 바랍니다. 원문의 원어 버전이 권위 있는 공식 문서로 간주되어야 합니다. 중요한 정보의 경우 전문가의 인간 번역을 권장합니다. 이 번역의 사용으로 인해 발생하는 오해나 잘못된 해석에 대해 당사는 책임을 지지 않습니다.
