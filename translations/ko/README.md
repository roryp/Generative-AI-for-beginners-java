...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-24T09:01:36+00:00",
...
**소요 시간**: 워크숍 전체는 로컬 설정 없이 온라인으로 완료할 수 있습니다. 환경 설정은 2분이 소요되며, 샘플 탐색은 탐구 깊이에 따라 1~3시간이 걸립니다.
...
### **5장: 책임 있는 AI 개발**
- **GitHub Models 안전성**: 내장된 콘텐츠 필터링 및 안전 메커니즘 테스트 (강력 차단 및 부드러운 거부)
...
제품에 대한 피드백을 제공하거나 개발 중 오류가 발생했다면 다음을 방문하세요:
