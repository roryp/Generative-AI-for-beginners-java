...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-27T08:31:44+00:00",
...
**Время выполнения**: Весь воркшоп можно пройти онлайн без локальной настройки. Если вы хотите запустить примеры, настройка окружения займет 2 минуты, а изучение примеров потребует от 1 до 3 часов в зависимости от глубины изучения.
