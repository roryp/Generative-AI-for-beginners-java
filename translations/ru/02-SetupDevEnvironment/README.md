...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-21T17:52:22+00:00",
...
- Настраивать среду разработки Java для приложений на основе ИИ
- Выбирать и конфигурировать предпочитаемую среду разработки (облачную с Codespaces, локальный контейнер разработки или полную локальную установку)
- Проверять настройку, подключаясь к моделям GitHub
...
> **Примечание**: GitHub Models, используемые в этом обучении, имеют следующие бесплатные ограничения:
> - 15 запросов в минуту (150 в день)
> - ~8,000 слов на входе, ~4,000 слов на выходе за запрос
> - 5 одновременных запросов
> 
> Для использования в продакшене обновитесь до Azure AI Foundry Models с вашей учетной записью Azure. Ваш код не требует изменений. См. [документацию Azure AI Foundry](https://learn.microsoft.com/azure/ai-foundry/foundry-models/how-to/quickstart-github-models).
...
8. В разделе "Repository access" выберите репозитории, которые вы хотите использовать с GitHub Models (или "All repositories", если необходимо).
...
> **Совет по безопасности**: Используйте минимально необходимые права и кратчайший возможный срок действия для ваших токенов доступа.

## Шаг 3: Проверка настройки с примером GitHub Models

Когда ваша среда разработки готова, давайте проверим интеграцию с GitHub Models, используя наше примерное приложение в [`02-SetupDevEnvironment/src/github-models`](../../../02-SetupDevEnvironment/src/github-models).
...
Сначала разберемся, что делает этот код. Пример использует OpenAI Java SDK для подключения к GitHub Models:
...
- **Подключились к GitHub Models** с помощью OpenAI Java SDK для бесплатного доступа к разработке ИИ
- **Проверили интеграцию** с рабочим примером приложения, которое взаимодействует с моделями ИИ
...
- **Токен не работает?** 
  - Убедитесь, что вы скопировали токен полностью, без лишних пробелов
