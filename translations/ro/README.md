...
**Timp necesar**: Întregul atelier poate fi finalizat online fără configurare locală. Configurarea mediului durează 2 minute, iar explorarea exemplarelor necesită între 1 și 3 ore, în funcție de adâncimea explorării.
...
5. Așteaptă ~2 minute ca mediul să fie gata
...
- **Ecosistem Java AI**: Prezentare generală a SDK-urilor Spring AI și OpenAI
...
- **Configurare multi-provider**: Setează integrările pentru GitHub Models, Azure OpenAI și OpenAI Java SDK
...
### **Capitolul 3: Tehnici fundamentale de Inteligență Artificială Generativă**
- **Prompt Engineering**: Tehnici pentru răspunsuri optime ale modelelor AI
- **Embedding-uri & operații vectoriale**: Implementarea căutării semantice și a potrivirilor de similaritate
- **Retrieval-Augmented Generation (RAG)**: Combină AI cu sursele tale de date
- **Apelarea funcțiilor**: Extinde capacitățile AI cu unelte și plugin-uri personalizate
- **[→ Începe Capitolul 3](./03-CoreGenerativeAITechniques/README.md)**

### **Capitolul 4: Aplicații practice & proiecte**
- **Generator de povești despre animale** (`petstory/`): Generare creativă de conținut cu GitHub Models
...
- **Siguranța GitHub Models**: Testează filtrele de conținut integrate și mecanismele de siguranță (blocări dure și refuzuri blânde)
...
### Seria Copilot
[![Copilot pentru Programare Asociată AI](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
...
Dacă întâmpinați dificultăți sau aveți întrebări despre crearea aplicațiilor AI. Alăturați-vă colegilor învățăcei și dezvoltatorilor experimentați în discuții despre MCP. Este o comunitate de susținere unde întrebările sunt binevenite și cunoștințele sunt împărtășite liber.
