...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-25T07:55:32+00:00",
...
> **NOTE: Start Rapid**: Cursul poate fi parcurs complet online - Nu este necesară configurarea locală!
1. Fork-uiți acest repository în contul dvs. GitHub
2. Click pe **Code** → **Codespaces** tab → **...** → **New with options...**
...
6. Treceti direct la [Crearea Token-ului pentru Modelele GitHub](./02-SetupDevEnvironment/README.md#step-2-create-a-github-personal-access-token)
...
**Timp Necesitat**: Configurarea mediului durează 2 minute, iar exemplele necesită 1-3 ore, în funcție de profunzimea explorării. Întregul workshop poate fi finalizat online, fără configurare locală.

### **Capitolul 1: Introducere în Generative AI**
- **Concepte de Bază**: Înțelegerea modelelor de limbaj mari, token-urilor, embedding-urilor și capacităților AI
...
- **Configurare Multi-Furnizor**: Configurați Modelele GitHub, Azure OpenAI și integrarea SDK-ului OpenAI Java
...
- [Mastering GitHub Copilot pentru Programare AI în Pereche](https://aka.ms/GitHubCopilotAI)
