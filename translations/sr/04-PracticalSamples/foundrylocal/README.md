...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-25T10:10:31+00:00",
  "source_file": "04-PracticalSamples/foundrylocal/README.md",
  "language_code": "sr"
}
-->
# Foundry локална командна апликација
...
- [Пример излазних података](../../../../04-PracticalSamples/foundrylocal)
...
3. **Покрените ваш први модел**:

   ```bash
   foundry model run phi-3.5-mini
   ```

   Модел се преузима (што може потрајати неколико минута, у зависности од брзине интернета) и затим покреће. Foundry Local аутоматски бира најбољу варијанту модела за ваш систем (CUDA за NVIDIA GPU-ове, CPU верзија у супротном).
...
Апликација се може конфигурисати кроз `application.properties`:
...
> **Напомена**: Назив модела у конфигурацији треба да одговара специфичној варијанти коју је Foundry Local преузео за ваш систем. Када покренете `foundry model run phi-3.5-mini`, Foundry Local аутоматски бира и преузима најбољу варијанту (CUDA за NVIDIA GPU-ове, CPU верзија у супротном). Користите `foundry model list` да видите тачан назив модела доступан у вашој локалној инстанци.

## Брзи почетак

### 1. Идите у директоријум апликације Foundry Local
```bash
...
2. **Аутоматски шаље** тест поруку: "Здраво! Можеш ли ми рећи шта си и који модел користиш?"
3. **Приказује одговор** од Foundry Local-а у конзоли
4. **Чисто излази** након демонстрације

## Пример излазних података
...
- Користи **OpenAI Java SDK** за типски безбедне API позиве
...
Прављење захтева за завршетак разговора је једноставно и типски безбедно:
...
4. Проверите да ли заштитни зид не блокира везу
...
- **Погрешан назив модела**: Користите `foundry model list` да видите доступне моделе и ажурирајте вашу конфигурацију у складу с тим
