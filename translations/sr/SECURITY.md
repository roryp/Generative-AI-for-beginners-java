...
Ако више волите да пријавите безбедносни проблем без пријављивања, пошаљите е-поруку на [secure@microsoft.com](mailto:secure@microsoft.com). Ако је могуће, шифрујте своју поруку нашим PGP кључем; преузмите га са странице [Microsoft Security Response Center PGP Key](https://aka.ms/security.md/msrc/pgp).
...
Ако пријављујете у оквиру програма за награде за багове, потпунији извештаји могу допринети већој награди. Молимо вас да посетите нашу страницу [Microsoft Bug Bounty Program](https://aka.ms/security.md/msrc/bounty) за више детаља о нашим активним програмима.
