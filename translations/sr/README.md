...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-23T12:38:24+00:00",
...
**Време потребно**: Подешавање окружења траје 2 минута, док практични туторијали захтевају 1-3 сата, у зависности од дубине истраживања.
...
- **Генерисање уз помоћ претраживања (RAG)**: Комбинација AI са сопственим изворима података
...
- [Савладавање GitHub Copilot-а за AI пар програмирање](https://aka.ms/GitHubCopilotAI)
