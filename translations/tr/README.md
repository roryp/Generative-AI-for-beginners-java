...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-21T17:33:24+00:00",
...
**Zaman Taahhüdü**: Ortam kurulumu 2 dakika sürer, uygulamalı eğitimler ise keşif derinliğine bağlı olarak her biri 1-3 saat gerektirir.

### **Bölüm 1: Üretken Yapay Zekaya Giriş**
- **Temel Kavramlar**: Büyük Dil Modellerini, tokenları, gömülemeleri ve yapay zeka yeteneklerini anlama
...
- **Prompt Mühendisliği**: Yapay zeka modellerinden en iyi yanıtları almak için teknikler
- **Gömülemeler ve Vektör İşlemleri**: Anlamsal arama ve benzerlik eşleştirme uygulamaları
