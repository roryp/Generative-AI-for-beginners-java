...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-18T10:46:27+00:00",
...
> ```
> ಇದು ಕೋರ್ಸ್ ಪೂರ್ಣಗೊಳಿಸಲು ಬೇಕಾದ ಎಲ್ಲವನ್ನೂ ನಿಮಗೆ ನೀಡುತ್ತದೆ ಮತ್ತು ಡೌನ್‌ಲೋಡ್ ವೇಗವನ್ನು ಹೆಚ್ಚಿಸುತ್ತದೆ.
...
- **ಬಹು-ಪ್ರದಾತ ಸಂರಚನೆ**: GitHub ಮಾದರಿಗಳು, ಅಜೂರ್ OpenAI, ಮತ್ತು OpenAI ಜಾವಾ SDK ಸಂಯೋಜನೆಗಳನ್ನು ಸೆಟ್ ಅಪ್ ಮಾಡಿ
...
- **ಫೌಂಡ್ರಿ ಸ್ಥಳೀಯ ಡೆಮೋ** (`foundrylocal/`): OpenAI ಜಾವಾ SDK ಮೂಲಕ ಸ್ಥಳೀಯ AI ಮಾದರಿ ಸಂಯೋಜನೆ
...
### ಕೋಪೈಲಟ್ ಸರಣಿ
[![ಕೋಪೈಲಟ್ ಫಾರ್ AI ಜೋಡಣಾ ಪ್ರೋಗ್ರಾಮಿಂಗ್](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
