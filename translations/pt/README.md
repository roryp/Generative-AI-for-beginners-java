...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T10:25:09+00:00",
...
- **Demo Local do Foundry** (`foundrylocal/`): Integração de modelo de IA local com OpenAI Java SDK
...
- **Segurança dos Modelos do GitHub**: Teste de filtragem de conteúdo integrada e mecanismos de segurança (bloqueios rígidos e recusas suaves)
...
- **Melhores Práticas**: Diretrizes essenciais para o desenvolvimento e implementação ética de IA
...
- [Aplicação de Chat RAG com Serviços de IA do Azure](https://github.com/Azure-Samples/azure-search-openai-demo-java)
