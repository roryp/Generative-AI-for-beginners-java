...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-23T11:50:53+00:00",
...
![Generative AI for Beginners - Java Edition](../../translated_images/beg-genai-series.61edc4a6b2cc54284fa2d70eda26dc0ca2669e26e49655b842ea799cd6e16d2a.en.png)

> **NOTE: Quick Start**: The entire course can be completed online - no local setup needed!
...
**Time Commitment**: Setting up the environment takes 2 minutes, and the hands-on tutorials require 1-3 hours each, depending on how deeply you explore.
...
- **Foundry Local Demo** (`foundrylocal/`): Integrate local AI models with the OpenAI Java SDK
