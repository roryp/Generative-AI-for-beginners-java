...
![图示：生成式 AI 模型类型及其应用场景。](../../../translated_images/llms.225ca2b8a0d34473.zh.png)
...
![图示：嵌入](../../../translated_images/embedding.398e50802c0037f9.zh.png)
...
![图示：向量数据库架构，展示嵌入如何存储和检索以进行相似性搜索。](../../../translated_images/vector.f12f114934e223df.zh.png)
...
![图示：从提示到回复的流程——包括 tokens、向量、可选的 RAG 查找、LLM 思考以及 MCP 代理的快速流程。](../../../translated_images/flow.f4ef62c3052d12a8.zh.png)
