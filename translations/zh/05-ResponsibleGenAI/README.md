...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-27T08:35:27+00:00",
...
GitHub Models 自带基础内容过滤功能。它就像您 AI 俱乐部里的友好门卫——虽然不算最复杂，但在基本场景下足够胜任。
...
恭喜您完成《生成式 AI 初学者》课程！您现在掌握了知识和工具，可以使用 Java 构建负责任且高效的生成式 AI 应用。
