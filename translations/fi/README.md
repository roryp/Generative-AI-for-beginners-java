...
**Aikavaatimukset**: Koko työpaja voidaan suorittaa verkossa ilman paikallista asennusta. Ympäristön asennus vie 2 minuuttia, ja esimerkkien tutkimiseen kuluu 1-3 tuntia riippuen tutkimisen syvyydestä.
...
- **Monitoimittajakonfiguraatio**: GitHub-mallien, Azure OpenAI:n ja OpenAI Java SDK:n integrointi
