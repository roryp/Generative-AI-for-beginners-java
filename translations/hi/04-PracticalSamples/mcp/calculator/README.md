...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-25T11:02:57+00:00",
...
यह क्लाइंट AI का उपयोग किए बिना सीधे MCP सर्वर से बात करता है। यह विशेष कैलकुलेटर फंक्शन्स को मैन्युअली कॉल करता है:
...
2. **AI को कनेक्ट करता है** हमारे कैलकुलेटर MCP सर्वर से
3. **AI को देता है** हमारे सभी कैलकुलेटर टूल्स तक पहुंच
...
जब आप AI से पूछते हैं "5 + 3 क्या है?" तो पूरा फ्लो इस प्रकार होता है:
...
6. **AI** परिणाम प्राप्त करता है और एक प्राकृतिक प्रतिक्रिया में फॉर्मेट करता है
