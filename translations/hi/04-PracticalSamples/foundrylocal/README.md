...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-03T20:01:51+00:00",
...
- [यह सब कैसे काम करता है](../../../../04-PracticalSamples/foundrylocal)
...
इस प्रोजेक्ट में चार मुख्य घटक शामिल हैं:
...
**यह क्या करता है:**
- **base-url**: यह निर्दिष्ट करता है कि Foundry Local कहाँ चल रहा है, `/v1` पथ सहित जो OpenAI API संगतता के लिए आवश्यक है। **नोट**: Foundry Local डायनामिक रूप से पोर्ट असाइन करता है, इसलिए `foundry service status` का उपयोग करके अपना वास्तविक पोर्ट जांचें।
...
- `:default-value` सिंटैक्स बैकअप वैल्यू प्रदान करता है यदि प्रॉपर्टीज सेट नहीं हैं।
...
- `application.properties` से बेस URL पहले से ही `/v1` शामिल करता है जो OpenAI API संगतता के लिए आवश्यक है।
- एपीआई कुंजी "not-needed" पर सेट है क्योंकि स्थानीय विकास में प्रमाणीकरण की आवश्यकता नहीं होती।
...
- **ChatCompletionCreateParams**: एआई अनुरोध को कॉन्फ़िगर करता है।
  ...
  - `maxTokens`: प्रतिक्रिया की लंबाई को सीमित करता है (संसाधनों को बचाने के लिए)।
...
8. **प्रदर्शन**: एप्लिकेशन प्रतिक्रिया को प्रिंट करता है और बंद हो जाता है।
...
4. **application.properties फ़ाइल को कॉन्फ़िगर करें** ताकि यह आपके Foundry Local सेटिंग्स से मेल खाए:
   - `base-url` में पोर्ट अपडेट करें (चरण 2 से), सुनिश्चित करें कि यह `/v1` के साथ समाप्त होता है।
   - मॉडल नाम को संस्करण संख्या सहित अपडेट करें (जाँच करें `foundry model list` के साथ)।
...
- मॉडल नाम को `application.properties` में सटीक रूप से अपडेट करें, जिसमें संस्करण संख्या भी शामिल हो (जैसे, `Phi-3.5-mini-instruct-cuda-gpu:1`)।
...
- सुनिश्चित करें कि आप अपने कोड में `maxTokens()` का उपयोग कर रहे हैं, न कि `maxCompletionTokens()`।

**Maven संकलन त्रुटियाँ**
- सुनिश्चित करें कि Java 21 या उच्चतर है: `java -version`
- साफ करें और पुनः बनाएं: `mvn clean compile`
- डिपेंडेंसी डाउनलोड के लिए इंटरनेट कनेक्शन जांचें।
...
- एप्लिकेशन लॉग में विशिष्ट त्रुटि संदेश जांचें।
