...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-27T12:59:38+00:00",
...
> **Azure OpenAI में रुचि है?**, हमारे [Azure OpenAI Setup Guide](getting-started-azure-openai.md) को देखें जिसमें नया Azure OpenAI संसाधन बनाने के चरण दिए गए हैं।
...
यह अध्याय आपको डेवलपमेंट एनवायरनमेंट सेटअप करने में मार्गदर्शन करेगा। हम **GitHub मॉडल्स** का उपयोग करेंगे क्योंकि यह मुफ़्त है, केवल GitHub अकाउंट के साथ सेटअप करना आसान है, क्रेडिट कार्ड की आवश्यकता नहीं है, और प्रयोग के लिए कई मॉडल्स तक पहुंच प्रदान करता है।
...
> **नोट**: इस प्रशिक्षण में उपयोग किए गए GitHub मॉडल्स के मुफ़्त सीमा:
> - 15 अनुरोध प्रति मिनट (150 प्रति दिन)
> - ~8,000 शब्द इनपुट, ~4,000 शब्द आउटपुट प्रति अनुरोध
> - 5 समवर्ती अनुरोध
> 
> उत्पादन उपयोग के लिए, अपने Azure अकाउंट के साथ Azure AI Foundry मॉडल्स में अपग्रेड करें। आपके कोड को बदलने की आवश्यकता नहीं है। [Azure AI Foundry दस्तावेज़](https://learn.microsoft.com/azure/ai-foundry/foundry-models/how-to/quickstart-github-models) देखें।

## चरण 1: अपना डेवलपमेंट एनवायरनमेंट सेटअप करें

<a name="quick-start-cloud"></a>

हमने इस जेनरेटिव AI के लिए जावा कोर्स के लिए आवश्यक सभी टूल्स के साथ एक प्री-कॉन्फ़िगर्ड डेवलपमेंट कंटेनर बनाया है ताकि सेटअप समय को कम किया जा सके। अपनी पसंद का डेवलपमेंट तरीका चुनें:
...
> - सभी टूल्स और डिपेंडेंसी के साथ प्री-कॉन्फ़िगर्ड
...
पहले, चलिए समझते हैं कि आपने अभी क्या चलाया। `examples/github-models` के तहत उदाहरण OpenAI Java SDK का उपयोग करता है GitHub मॉडल्स से कनेक्ट करने के लिए:
...
- **पुष्टि करता है** कि आपका सेटअप सही ढंग से काम कर रहा है
...
- **GitHub पर्सनल एक्सेस टोकन बनाया** AI मॉडल एक्सेस के लिए उचित अनुमतियों के साथ
- **जावा डेवलपमेंट एनवायरनमेंट सेटअप किया** Codespaces, डेव कंटेनर्स, या लोकल इंस्टॉलेशन का उपयोग करके
- **GitHub मॉडल्स से कनेक्ट किया** OpenAI Java SDK का उपयोग करके मुफ़्त AI डेवलपमेंट एक्सेस के लिए
- **इंटीग्रेशन का परीक्षण किया** एक कार्यशील उदाहरण एप्लिकेशन के साथ जो AI मॉडल्स के साथ संवाद करता है
...
समस्याएँ हो रही हैं? यहाँ सामान्य समस्याएँ और समाधान दिए गए हैं:
...
- **एप्लिकेशन संकलन त्रुटियाँ?**
  ...
  - साफ़ और पुनर्निर्माण का प्रयास करें: `mvn clean compile`

> **मदद चाहिए?**: अभी भी समस्याएँ हो रही हैं? रिपॉजिटरी में एक इश्यू खोलें और हम आपकी मदद करेंगे।
