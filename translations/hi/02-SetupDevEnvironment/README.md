...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-21T16:20:51+00:00",
...
- अपनी पसंदीदा डेवलपमेंट एनवायरनमेंट चुनना और कॉन्फ़िगर करना (Codespaces के साथ क्लाउड-फर्स्ट, लोकल डेव कंटेनर, या पूरी लोकल सेटअप)
...
यह अध्याय आपको डेवलपमेंट एनवायरनमेंट सेटअप करने में मार्गदर्शन करेगा। हम **GitHub मॉडल्स** का उपयोग करेंगे क्योंकि यह मुफ़्त है, केवल GitHub अकाउंट के साथ सेटअप करना आसान है, क्रेडिट कार्ड की आवश्यकता नहीं है, और कई मॉडल्स तक पहुंच प्रदान करता है।
...
> - 5 समवर्ती अनुरोध
> 
> प्रोडक्शन उपयोग के लिए, अपने Azure अकाउंट के साथ Azure AI Foundry मॉडल्स में अपग्रेड करें। आपके कोड को बदलने की आवश्यकता नहीं है। [Azure AI Foundry दस्तावेज़](https://learn.microsoft.com/azure/ai-foundry/foundry-models/how-to/quickstart-github-models) देखें।

## चरण 1: अपना डेवलपमेंट एनवायरनमेंट सेट करें

<a name="quick-start-cloud"></a>

हमने इस जेनरेटिव AI फॉर जावा कोर्स के लिए आवश्यक सभी टूल्स के साथ एक प्री-कॉन्फ़िगर्ड डेवलपमेंट कंटेनर बनाया है ताकि सेटअप समय को कम किया जा सके। अपनी पसंदीदा डेवलपमेंट विधि चुनें:
...
5. जब संकेत मिले, **Reopen in Container** पर क्लिक करें (या `Ctrl+Shift+P` → "Dev Containers: Reopen in Container" का उपयोग करें)
...
पहले, चलिए समझते हैं कि हम क्या चलाने जा रहे हैं। उदाहरण OpenAI Java SDK का उपयोग करता है GitHub मॉडल्स से कनेक्ट करने के लिए:
...
- **GitHub पर्सनल एक्सेस टोकन बनाया** AI मॉडल एक्सेस के लिए सही अनुमतियों के साथ
...
- **Maven नहीं मिला?** 
  ...
  - `mvn --version` का उपयोग करके इंस्टॉलेशन सत्यापित करें
...
- **एप्लिकेशन संकलन त्रुटियाँ?**
  ...
  - सफाई और पुनर्निर्माण का प्रयास करें: `mvn clean compile`
