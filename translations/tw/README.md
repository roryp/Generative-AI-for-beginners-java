...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-21T15:50:56+00:00",
...
- **負責任的 AI 演示**：展示 AI 安全過濾器實際運作的實操示例
...
- [使用 JavaScript 的生成式 AI 入門](https://github.com/microsoft/generative-ai-with-javascript)
