...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-29T08:26:18+00:00",
...
![初學者的生成式人工智慧 - Java 版](../../translated_images/beg-genai-series.8b48be9951cc574c25f8a3accba949bfd03c2f008e2c613283a1b47316fbee68.tw.png)

**所需時間**：整個工作坊可在線上完成，無需本地設置。環境設置僅需 2 分鐘，探索範例的時間依探索深度而定，約需 1-3 小時。
...
### **第五章：負責任的 AI 開發**
- **GitHub Models 安全性**：測試內建的內容過濾和安全機制（硬性阻擋和軟性拒絕）
