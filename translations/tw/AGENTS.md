...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-03T08:30:34+00:00",
...
這是一個用於學習使用 Java 開發生成式 AI的教育性資源庫。它提供了一個全面的實作課程，涵蓋大型語言模型 (LLMs)、提示工程、嵌入技術、RAG（檢索增強生成）以及模型上下文協議 (MCP)。
