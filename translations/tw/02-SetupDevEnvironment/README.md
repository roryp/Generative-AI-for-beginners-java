...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-29T08:28:00+00:00",
...
5. 等待約 2 分鐘，環境準備就緒
6. 繼續執行 [步驟 2：創建 GitHub 令牌](../../../02-SetupDevEnvironment)
...
6. 等待容器構建並啟動
7. 繼續執行 [步驟 2：創建 GitHub 令牌](../../../02-SetupDevEnvironment)
...
1. 將此倉庫克隆到您的本地機器
2. 在您的 IDE 中打開該項目
3. 繼續執行 [步驟 2：創建 GitHub 令牌](../../../02-SetupDevEnvironment)

> **專業提示**：如果您的機器配置較低，但希望本地使用 VS Code，可以使用 GitHub Codespaces！您可以將本地 VS Code 連接到雲端托管的 Codespace，享受兩全其美的體驗。
