...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-21T16:15:06+00:00",
...
> **快速開始**：在雲端中編碼只需 2 分鐘 - 跳至 [GitHub Codespaces 設置](../../../02-SetupDevEnvironment) - 無需本地安裝，並使用 GitHub 模型！

> **對 Azure OpenAI 感興趣嗎？** 請參閱我們的 [Azure OpenAI 設置指南](getting-started-azure-openai.md)，了解如何創建新的 Azure OpenAI 資源。

## 您將學到什麼

- 設置用於 AI 應用的 Java 開發環境
...
> - 5 個並發請求
> 
> 若需生產環境使用，請升級至 Azure AI Foundry 模型，並使用您的 Azure 帳戶。您的代碼無需更改。請參閱 [Azure AI Foundry 文檔](https://learn.microsoft.com/azure/ai-foundry/foundry-models/how-to/quickstart-github-models)。
...
當您的開發環境準備就緒後，讓我們使用 [`02-SetupDevEnvironment/src/github-models`](../../../02-SetupDevEnvironment/src/github-models) 中的示例應用測試 GitHub 模型集成。
...
- **連接到 GitHub 模型**，使用 OpenAI Java SDK 獲得免費的 AI 開發訪問
- **測試集成**，通過運行示例應用程序與 AI 模型通信
...
- **應用程序編譯錯誤？**
  - 確保您在正確的目錄中：`02-SetupDevEnvironment/src/github-models`
