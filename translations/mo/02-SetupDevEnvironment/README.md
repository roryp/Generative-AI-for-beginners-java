...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-23T12:00:52+00:00",
...
> **快速開始**：2 分鐘內在雲端編碼 - 跳到 [GitHub Codespaces 設置](../../../02-SetupDevEnvironment) - 無需本地安裝，使用 GitHub 模型！
...
> - 5 個並發請求
> 
> 若需生產環境使用，可升級到 Azure AI Foundry 模型，使用你的 Azure 帳戶。代碼無需更改。請參閱 [Azure AI Foundry 文檔](https://learn.microsoft.com/azure/ai-foundry/foundry-models/how-to/quickstart-github-models)。
...
8. 在 "Repository access" 下，選擇你想與 GitHub 模型一起使用的倉庫（或選擇 "All repositories" 如果需要）。
9. 在 "Repository permissions" 下，找到 **Models** 並設置為 **Read and write**。
10. 點擊 **Generate token**。
11. **立即複製並保存你的令牌** - 你將無法再次查看！
...
首先，讓我們理解剛剛運行的內容。`src/github-models` 下的示例使用 OpenAI Java SDK 連接到 GitHub 模型：
...
- **設置了 Java 開發環境**，使用 Codespaces、開發容器或本地安裝
- **連接到 GitHub 模型**，使用 OpenAI Java SDK 免費進行 AI 開發
- **測試了集成**，通過一個能與 AI 模型通信的工作示例應用
...
- **找不到 Maven？**  
  ...
  - 對於本地設置，確保安裝了 Java 21+ 和 Maven 3.9+  
