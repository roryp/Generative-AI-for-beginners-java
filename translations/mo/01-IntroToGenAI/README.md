...
![圖示：生成式人工智慧模型類型及其應用場景。](../../../translated_images/llms.225ca2b8a0d34473.mo.png)
...
![圖示：嵌入](../../../translated_images/embedding.398e50802c0037f9.mo.png)
...
![圖示：向量資料庫架構，展示如何儲存和檢索嵌入以進行相似性搜尋。](../../../translated_images/vector.f12f114934e223df.mo.png)
...
![圖示：從提示到回應的流程——tokens、向量、可選的 RAG 查詢、LLM 思考以及 MCP 代理的快速流程。](../../../translated_images/flow.f4ef62c3052d12a8.mo.png)
