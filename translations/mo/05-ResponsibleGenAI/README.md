...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-21T17:48:28+00:00",
...
本章節聚焦於構建負責任且符合倫理的生成式 AI 應用程式的關鍵要素。你將學習如何實現安全措施、處理內容過濾，並應用負責任的 AI 開發最佳實踐，這些工具與框架已在前幾章中介紹。理解這些原則對於構建不僅技術上令人印象深刻，且安全、符合倫理並值得信賴的 AI 系統至關重要。

## GitHub Models 的內建安全功能

GitHub Models 提供了基本的內容過濾功能，就像 AI 俱樂部裡的一位友善保安——雖然不算最精密，但對於基本場景已足夠應對。
...
![負責任的 AI 安全演示](../../../translated_images/responsible.d11c51f81baaa03084e44a1016936cf77a89971dce9927ec992bf2482d00a944.mo.png)
...
恭喜完成《生成式 AI 初學者》課程！你現在擁有構建負責任且有效的生成式 AI 應用程式的知識與工具。

![課程完成](../../../translated_images/image.ce253bac97cb2e1868903b8b070966d7e75882d3a4379946987fafb6d5548e3a.mo.png)
