...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-25T07:38:19+00:00",
...
![初學者生成式 AI - Java 版](../../translated_images/beg-genai-series.61edc4a6b2cc54284fa2d70eda26dc0ca2669e26e49655b842ea799cd6e16d2a.mo.png)
...
**時間投入**：環境設置僅需 2 分鐘，範例探索深度不同需 1-3 小時。整個工作坊可在線完成，無需本地設置。
...
- **Foundry 本地演示** (`foundrylocal/`)：使用 OpenAI Java SDK 進行本地 AI 模型集成
