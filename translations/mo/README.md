...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-18T09:39:51+00:00",
...
**時間投入**：整個工作坊可在線完成，無需本地設置。環境設置約需 2 分鐘，探索範例視探索深度需 1-3 小時。
...
> **偏好本地克隆？**
>
> 此存儲庫包含 50 多種語言翻譯，顯著增加下載大小。若要不含翻譯克隆，請使用稀疏檢出：
> ```bash
...
### **第四章：實務應用與專案**
- **寵物故事生成器** (`petstory/`)：使用 GitHub Models 創意內容生成
