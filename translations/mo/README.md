...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T16:58:39+00:00",
...
**所需時間**：整個工作坊可在線完成，無需本地設置。環境設置需時約2分鐘，探索範例需時1至3小時，視乎探索深度而定。
...
如果你遇到困難或對於建立 AI 應用程式有任何疑問，可以加入其他學習者和有經驗的開發者，一起討論 MCP。這是一個支持性的社群，歡迎提出問題並自由分享知識。
