...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T09:53:34+00:00",
...
![生成式 AI 初學者指南 - Java 版](../../translated_images/beg-genai-series.8b48be9951cc574c25f8a3accba949bfd03c2f008e2c613283a1b47316fbee68.mo.png)

**時間投入**：整個工作坊可在線完成，無需本地設置。環境設置約需 2 分鐘，探索範例則視探索深度需 1-3 小時。
...
> **偏好本地克隆？**
>
> 此儲存庫包含 50 多種語言翻譯，顯著增加下載大小。若要不含翻譯克隆，請使用稀疏檢出：
> ```bash
