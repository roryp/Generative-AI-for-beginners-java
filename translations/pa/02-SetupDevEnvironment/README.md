...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-27T13:03:25+00:00",
...
> **ਤੁਰੰਤ ਸ਼ੁਰੂਆਤ**: ਕਲਾਉਡ ਵਿੱਚ 2 ਮਿੰਟਾਂ ਵਿੱਚ ਕੋਡ ਕਰੋ - [GitHub Codespaces ਸੈਟਅੱਪ](../../../02-SetupDevEnvironment) 'ਤੇ ਜਾਓ - ਕੋਈ ਲੋਕਲ ਇੰਸਟਾਲੇਸ਼ਨ ਦੀ ਲੋੜ ਨਹੀਂ ਅਤੇ GitHub ਮਾਡਲ ਵਰਤਦਾ ਹੈ!
...
- [ਪਹਿਲਾ ਕਦਮ: ਆਪਣਾ ਵਿਕਾਸੀ ਮਾਹੌਲ ਸੈਟਅੱਪ ਕਰੋ](../../../02-SetupDevEnvironment)
  - [ਵਿਕਲਪ A: GitHub Codespaces (ਸਿਫਾਰਸ਼ੀ)](../../../02-SetupDevEnvironment)
...
ਇਹ ਅਧਿਆਇ ਤੁਹਾਨੂੰ ਵਿਕਾਸੀ ਮਾਹੌਲ ਸੈਟਅੱਪ ਕਰਨ ਵਿੱਚ ਮਦਦ ਕਰੇਗਾ। ਅਸੀਂ **GitHub ਮਾਡਲ** ਨੂੰ ਆਪਣੀ ਮੁੱਖ ਉਦਾਹਰਣ ਵਜੋਂ ਵਰਤਾਂਗੇ ਕਿਉਂਕਿ ਇਹ ਮੁਫ਼ਤ ਹੈ, ਸਿਰਫ਼ GitHub ਖਾਤੇ ਨਾਲ ਸੈਟਅੱਪ ਕਰਨਾ ਆਸਾਨ ਹੈ, ਕਿਸੇ ਕਰੈਡਿਟ ਕਾਰਡ ਦੀ ਲੋੜ ਨਹੀਂ ਹੈ, ਅਤੇ ਪ੍ਰਯੋਗ ਲਈ ਕਈ ਮਾਡਲਾਂ ਤੱਕ ਪਹੁੰਚ ਪ੍ਰਦਾਨ ਕਰਦਾ ਹੈ।
...
- **ਆਸਾਨ** ਹੈ ਸੈਟਅੱਪ ਕਰਨ ਲਈ ਸਿਰਫ਼ GitHub ਖਾਤੇ ਨਾਲ
...
## ਪਹਿਲਾ ਕਦਮ: ਆਪਣਾ ਵਿਕਾਸੀ ਮਾਹੌਲ ਸੈਟਅੱਪ ਕਰੋ
...
6. [Step 2: GitHub Token ਬਣਾਓ](../../../02-SetupDevEnvironment) 'ਤੇ ਜਾਓ।
...
7. [Step 2: GitHub Token ਬਣਾਓ](../../../02-SetupDevEnvironment) 'ਤੇ ਜਾਓ।
...
3. [Step 2: GitHub Token ਬਣਾਓ](../../../02-SetupDevEnvironment) 'ਤੇ ਜਾਓ।
...
1. [GitHub ਸੈਟਿੰਗ](https://github.com/settings/profile) 'ਤੇ ਜਾਓ ਅਤੇ ਆਪਣੇ ਪ੍ਰੋਫਾਈਲ ਮੀਨੂ ਤੋਂ **Settings** ਚੁਣੋ।
2. ਖੱਬੇ ਸਾਈਡਬਾਰ ਵਿੱਚ, **Developer settings** 'ਤੇ ਕਲਿੱਕ ਕਰੋ (ਆਮ ਤੌਰ 'ਤੇ ਹੇਠਾਂ)।
3. **Personal access tokens** ਹੇਠਾਂ, **Fine-grained tokens** 'ਤੇ ਕਲਿੱਕ ਕਰੋ (ਜਾਂ ਇਸ ਸਿੱਧੇ [ਲਿੰਕ](https://github.com/settings/personal-access-tokens) ਨੂੰ ਫੋਲੋ ਕਰੋ)।
4. **Generate new token** 'ਤੇ ਕਲਿੱਕ ਕਰੋ।
5. "Token name" ਹੇਠਾਂ, ਇੱਕ ਵਰਣਨਾਤਮਕ ਨਾਮ ਦਿਓ (ਜਿਵੇਂ, `GenAI-Java-Course-Token`)।
6. ਮਿਆਦ ਦੀ ਮਿਤੀ ਸੈੱਟ ਕਰੋ (ਸੁਰੱਖਿਆ ਲਈ ਸਿਫਾਰਸ਼ੀ: 7 ਦਿਨ)।
7. "Resource owner" ਹੇਠਾਂ, ਆਪਣਾ ਯੂਜ਼ਰ ਖਾਤਾ ਚੁਣੋ।
8. "Repository access" ਹੇਠਾਂ, ਉਹ ਰਿਪੋਜ਼ਟਰੀ ਚੁਣੋ ਜੋ ਤੁਸੀਂ GitHub ਮਾਡਲਾਂ ਨਾਲ ਵਰਤਣਾ ਚਾਹੁੰਦੇ ਹੋ (ਜਾਂ "All repositories" ਜੇ ਲੋੜ ਹੋਵੇ)।
9. "Repository permissions" ਹੇਠਾਂ, **Models** ਲੱਭੋ ਅਤੇ ਇਸਨੂੰ **Read and write** 'ਤੇ ਸੈੱਟ ਕਰੋ।
...
## ਤੀਜਾ ਕਦਮ: GitHub ਮਾਡਲ ਦੇ ਉਦਾਹਰਣ ਨਾਲ ਆਪਣਾ ਸੈਟਅੱਪ ਟੈਸਟ ਕਰੋ

ਜਦੋਂ ਤੁਹਾਡਾ ਵਿਕਾਸੀ ਮਾਹੌਲ ਤਿਆਰ ਹੋ ਜਾਵੇ, ਆਓ GitHub ਮਾਡਲ ਇੰਟਿਗ੍ਰੇਸ਼ਨ ਨੂੰ ਸਾਡੇ ਉਦਾਹਰਣ ਐਪਲੀਕੇਸ਼ਨ ਨਾਲ ਟੈਸਟ ਕਰੀਏ ਜੋ [`02-SetupDevEnvironment/examples/github-models`](../../../02-SetupDevEnvironment/examples/github-models) ਵਿੱਚ ਹੈ।

1. ਆਪਣੇ ਵਿਕਾਸੀ ਮਾਹੌਲ ਵਿੱਚ ਟਰਮੀਨਲ ਖੋਲ੍ਹੋ।
2. GitHub ਮਾਡਲ ਦੇ ਉਦਾਹਰਣ ਵਿੱਚ ਜਾਓ:
   ```bash
...
ਸਭ ਤੋਂ ਪਹਿਲਾਂ, ਆਓ ਸਮਝੀਏ ਕਿ ਅਸੀਂ ਕੀ ਚਲਾਇਆ। `examples/github-models` ਹੇਠਲੇ ਉਦਾਹਰਣ ਨੇ OpenAI Java SDK ਵਰਤ ਕੇ GitHub ਮਾਡਲਾਂ ਨਾਲ ਕਨੈਕਟ ਕੀਤਾ:
...
- **GitHub ਪੈਰਸਨਲ ਐਕਸੈਸ ਟੋਕਨ ਬਣਾਇਆ** ਸਹੀ ਅਧਿਕਾਰਾਂ ਨਾਲ AI ਮਾਡਲ ਪਹੁੰਚ ਲਈ
- **ਜਾਵਾ ਵਿਕਾਸੀ ਮਾਹੌਲ ਸੈਟਅੱਪ ਕੀਤਾ** Codespaces, ਡਿਵ ਕੰਟੇਨਰਾਂ ਜਾਂ ਲੋਕਲ ਇੰਸਟਾਲੇਸ਼ਨ ਦੀ ਵਰਤੋਂ ਕਰਕੇ
- **GitHub ਮਾਡਲਾਂ ਨਾਲ ਕਨੈਕਟ ਕੀਤਾ** OpenAI Java SDK ਦੀ ਵਰਤੋਂ ਕਰਕੇ ਮੁਫ਼ਤ AI ਵਿਕਾਸ ਪਹੁੰਚ ਲਈ
- **ਇੰਟਿਗ੍ਰੇਸ਼ਨ ਟੈਸਟ ਕੀਤਾ** ਇੱਕ ਕੰਮ ਕਰਦੇ ਉਦਾਹਰਣ ਐਪਲੀਕੇਸ਼ਨ ਨਾਲ ਜੋ AI ਮਾਡਲਾਂ ਨਾਲ ਸੰਚਾਰ ਕਰਦਾ ਹੈ
...
ਮਸਲੇ ਆ ਰਹੇ ਹਨ? ਇੱਥੇ ਕੁਝ ਆਮ ਸਮੱਸਿਆਵਾਂ ਅਤੇ ਹੱਲ ਹਨ:
...
- **ਕਨੈਕਸ਼ਨ ਸਮੱਸਿਆਵਾਂ?** 
  ...
  - ਜਾਂਚੋ ਕਿ ਤੁਸੀਂ ਕਿਸੇ ਫਾਇਰਵਾਲ ਦੇ
