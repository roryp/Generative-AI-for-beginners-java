...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-03T20:04:33+00:00",
...
**ਇਹ ਕੀ ਕਰਦਾ ਹੈ:**
- **base-url**: ਦੱਸਦਾ ਹੈ ਕਿ Foundry Local ਕਿੱਥੇ ਚਲ ਰਿਹਾ ਹੈ, `/v1` ਪਾਥ ਸਮੇਤ OpenAI API ਅਨੁਕੂਲਤਾ ਲਈ। **ਨੋਟ**: Foundry Local ਡਾਇਨੈਮਿਕ ਤੌਰ 'ਤੇ ਪੋਰਟ ਅਸਾਈਨ ਕਰਦਾ ਹੈ, ਇਸ ਲਈ `foundry service status` ਦੀ ਵਰਤੋਂ ਕਰਕੇ ਆਪਣੀ ਅਸਲ ਪੋਰਟ ਚੈੱਕ ਕਰੋ।
- **model**: AI ਮਾਡਲ ਦਾ ਨਾਮ ਦਿੰਦਾ ਹੈ ਜੋ ਟੈਕਸਟ ਜਨਰੇਸ਼ਨ ਲਈ ਵਰਤਿਆ ਜਾਣਾ ਹੈ, ਵਰਜਨ ਨੰਬਰ ਸਮੇਤ (ਜਿਵੇਂ, `:1`)। ਉਪਲਬਧ ਮਾਡਲ ਦੇ ਸਹੀ ID ਦੇਖਣ ਲਈ `foundry model list` ਦੀ ਵਰਤੋਂ ਕਰੋ।
...
- `:default-value` ਸਿੰਟੈਕਸ ਫਾਲਬੈਕ ਮੁੱਲ ਪ੍ਰਦਾਨ ਕਰਦਾ ਹੈ ਜੇ ਗੁਣ ਸੈਟ ਨਹੀਂ ਕੀਤੇ ਗਏ

#### ਕਲਾਇੰਟ ਇਨਿਸ਼ੀਅਲਾਈਜ਼ੇਸ਼ਨ:
```java
@PostConstruct
public void init() {
...
**ਇਹ ਕੀ ਕਰਦਾ ਹੈ:**
- `@PostConstruct` Spring ਦੁਆਰਾ ਸੇਵਾ ਬਣਾਉਣ ਤੋਂ ਬਾਅਦ ਇਸ ਮੈਥਡ ਨੂੰ ਚਲਾਉਂਦਾ ਹੈ
- ਇੱਕ OpenAI ਕਲਾਇੰਟ ਬਣਾਉਂਦਾ ਹੈ ਜੋ ਤੁਹਾਡੇ ਸਥਾਨਕ Foundry Local ਇੰਸਟੈਂਸ ਨੂੰ ਪੋਇੰਟ ਕਰਦਾ ਹੈ
- `application.properties` ਤੋਂ ਆਧਾਰ URL ਪਹਿਲਾਂ ਹੀ `/v1` ਸ਼ਾਮਲ ਕਰਦਾ ਹੈ OpenAI API ਅਨੁਕੂਲਤਾ ਲਈ
- API ਕੁੰਜੀ "not-needed" ਸੈਟ ਕੀਤੀ ਜਾਂਦੀ ਹੈ ਕਿਉਂਕਿ ਸਥਾਨਕ ਵਿਕਾਸ ਵਿੱਚ ਪ੍ਰਮਾਣਿਕਤਾ ਦੀ ਲੋੜ ਨਹੀਂ ਹੁੰਦੀ
...
- **ChatCompletionCreateParams**: AI ਬੇਨਤੀ ਨੂੰ ਕਨਫਿਗਰ ਕਰਦਾ ਹੈ
  - `model`: ਦੱਸਦਾ ਹੈ ਕਿ ਕਿਹੜਾ AI ਮਾਡਲ ਵਰਤਣਾ ਹੈ (ਉਪਲਬਧ ਮਾਡਲ ID ਦੇ ਨਾਲ ਮੇਲ ਖਾਣਾ ਚਾਹੀਦਾ ਹੈ)
  - `addUserMessage`: ਗੱਲਬਾਤ ਵਿੱਚ ਤੁਹਾਡਾ ਸੁਨੇਹਾ ਸ਼ਾਮਲ ਕਰਦਾ ਹੈ
  - `maxTokens`: ਜਵਾਬ ਦੀ ਲੰਬਾਈ ਸੀਮਿਤ ਕਰਦਾ ਹੈ (ਸੰਸਾਧਨਾਂ ਦੀ ਬਚਤ ਕਰਦਾ ਹੈ)
...
- **openai-java**: API ਸੰਚਾਰ ਲਈ ਅਧਿਕਾਰਤ OpenAI Java SDK
...
3. **ਕਲਾਇੰਟ ਸੈਟਅੱਪ**: `@PostConstruct` OpenAI ਕਲਾਇੰਟ ਨੂੰ Foundry Local ਨਾਲ ਕਨੈਕਟ ਕਰਨ ਲਈ ਇਨਿਸ਼ੀਅਲਾਈਜ਼ ਕਰਦਾ ਹੈ
...
Foundry Local ਸੈਟਅੱਪ ਕਰਨ ਲਈ, ਹੇਠਾਂ ਦਿੱਤੇ ਕਦਮਾਂ ਦੀ ਪਾਲਣਾ ਕਰੋ:

1. **Foundry Local ਇੰਸਟਾਲ ਕਰੋ** [ਪੂਰਵ ਸ਼ਰਤਾਂ](../../../../04-PracticalSamples/foundrylocal) ਸੈਕਸ਼ਨ ਵਿੱਚ ਦਿੱਤੀਆਂ ਹਦਾਇਤਾਂ ਦੀ ਪਾਲਣਾ ਕਰਦੇ ਹੋਏ।

2. **ਡਾਇਨੈਮਿਕ ਤੌਰ 'ਤੇ ਅਸਾਈਨ ਕੀਤੇ ਪੋਰਟ ਨੂੰ ਚੈੱਕ ਕਰੋ**। Foundry Local ਆਪਣੇ ਆਪ ਪੋਰਟ ਅਸਾਈਨ ਕਰਦਾ ਹੈ ਜਦੋਂ ਇਹ ਸ਼ੁਰੂ ਹੁੰਦਾ ਹੈ। ਆਪਣੀ ਪੋਰਟ ਪਤਾ ਕਰਨ ਲਈ:
   ```bash
   foundry service status
   ```
   
   **ਵਿਕਲਪਿਕ**: ਜੇ ਤੁਸੀਂ ਇੱਕ ਖਾਸ ਪੋਰਟ (ਜਿਵੇਂ, 5273) ਦੀ ਵਰਤੋਂ ਕਰਨਾ ਪਸੰਦ ਕਰਦੇ ਹੋ, ਤਾਂ ਤੁਸੀਂ ਇਸਨੂੰ ਮੈਨੂਅਲੀ ਤੌਰ 'ਤੇ ਕਨਫਿਗਰ ਕਰ ਸਕਦੇ ਹੋ:
   ```bash
...
4. **application.properties ਫਾਇਲ ਕਨਫਿਗਰ ਕਰੋ** ਜੋ ਤੁਹਾਡੇ Foundry Local ਸੈਟਅੱਪ ਨਾਲ ਮੇਲ ਖਾਂਦੀ ਹੋਵੇ:
   - `base-url` ਵਿੱਚ ਪੋਰਟ ਅਪਡੇਟ ਕਰੋ (ਕਦਮ 2 ਤੋਂ), ਇਹ ਯਕੀਨੀ ਬਣਾਓ ਕਿ ਇਸ ਦੇ ਅੰਤ ਵਿੱਚ `/v1` ਸ਼ਾਮਲ ਹੈ
   - ਮਾਡਲ ਦਾ ਨਾਮ ਅਪਡੇਟ ਕਰੋ ਜਿਸ ਵਿੱਚ ਵਰਜਨ ਨੰਬਰ ਸ਼ਾਮਲ ਹੋਵੇ (ਚੈੱਕ ਕਰੋ `foundry model list` ਨਾਲ)
...
- Foundry Local ਕਿਹੜੀ ਪੋਰਟ ਵਰਤ ਰਿਹਾ ਹੈ, ਇਹ ਚੈੱਕ ਕਰੋ: `foundry service status`
- ਆਪਣੀ `application.properties` ਨੂੰ ਸਹੀ ਪੋਰਟ ਨਾਲ ਅਪਡੇਟ ਕਰੋ, ਇਹ ਯਕੀਨੀ ਬਣਾਓ ਕਿ URL ਦੇ ਅੰਤ ਵਿੱਚ `/v1` ਹੈ
- ਵਿਕਲਪਕ ਤੌਰ 'ਤੇ, ਜੇ ਚਾਹੋ ਤਾਂ ਖਾਸ ਪੋਰਟ ਸੈਟ ਕਰੋ: `foundry service set --port 5273`
- Foundry Local ਨੂੰ ਦੁਬਾਰਾ ਸ਼ੁਰੂ ਕਰਨ ਦੀ ਕੋਸ਼ਿਸ਼ ਕਰੋ: `foundry model run phi-3.5-mini`

**"Model not found" ਜਾਂ "404 Not Found" errors**
- ਉਪਲਬਧ ਮਾਡਲਾਂ ਨੂੰ ਸਹੀ ID ਦੇ ਨਾਲ ਚੈੱਕ ਕਰੋ: `foundry model list`
- `application.properties` ਵਿੱਚ ਮਾਡਲ ਦਾ ਨਾਮ ਸਹੀ ਤੌਰ 'ਤੇ ਅਪਡੇਟ ਕਰੋ, ਜਿਸ ਵਿੱਚ ਵਰਜਨ ਨੰਬਰ ਸ਼ਾਮਲ ਹੋਵੇ (ਜਿਵੇਂ, `Phi-3.5-mini-instruct-cuda-gpu:1`)
- ਯਕੀਨੀ ਬਣਾਓ ਕਿ `base-url` ਦੇ ਅੰਤ ਵਿੱਚ `/v1` ਸ਼ਾਮਲ ਹੈ: `http://localhost:5273/v1`
- ਜੇ ਲੋੜ ਹੋਵੇ ਤਾਂ ਮਾਡਲ ਡਾਊਨਲੋਡ ਕਰੋ: `foundry model run phi-3.5-mini`

**"400 Bad Request" errors**
- ਯਕੀਨੀ ਬਣਾਓ ਕਿ base URL ਵਿੱਚ `/v1` ਸ਼ਾਮਲ ਹੈ: `http://localhost:5273/v1`
- ਚੈੱਕ ਕਰੋ ਕਿ ਮਾਡਲ ID ਸਹੀ ਤੌਰ 'ਤੇ `foundry model list` ਵਿੱਚ ਦਿੱਤੇ ID ਨਾਲ ਮੇਲ ਖਾਂਦੀ ਹੈ
- ਯਕੀਨੀ ਬਣਾਓ ਕਿ ਤੁਸੀਂ ਆਪਣੇ ਕੋਡ ਵਿੱਚ `maxTokens()` ਦੀ ਵਰਤੋਂ ਕਰ ਰਹੇ ਹੋ ਨਾ ਕਿ `maxCompletionTokens()`

**Maven ਕੰਪਾਇਲੇਸ਼ਨ errors**
- Java 21 ਜਾਂ ਇਸ ਤੋਂ ਉੱਚਾ ਯਕੀਨੀ ਬਣਾਓ: `java -version`
- ਸਾਫ਼ ਕਰੋ ਅਤੇ ਦੁਬਾਰਾ ਬਣਾਓ: `mvn clean compile`
...
- ਐਪਲੀਕੇਸ਼ਨ ਲਾਗਜ਼ ਵਿੱਚ ਖਾਸ ਗਲਤੀ ਸੁਨੇਹੇ ਚੈੱਕ ਕਰੋ
- ਯਕੀਨੀ ਬਣਾਓ ਕਿ ਮਾਡਲ ਪੂਰੀ ਤਰ੍ਹਾਂ ਲੋਡ ਹੋ ਚੁੱਕਾ ਹੈ ਅਤੇ ਤਿਆਰ ਹੈ
