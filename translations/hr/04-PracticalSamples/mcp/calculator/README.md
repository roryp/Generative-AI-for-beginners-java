...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-25T12:03:45+00:00",
...
- Kreira `ToolCallbackProvider` koji omogućuje da metode kalkulatora budu dostupne kao MCP alati
...
- `divide(a, b)` - Dijeli prvi broj s drugim (provjera za nulu)
- `power(base, exponent)` - Podiže osnovu na potenciju eksponenta
- `squareRoot(number)` - Računa kvadratni korijen (provjera za negativne brojeve)
...
2. **Prikazuje** sve dostupne alate (funkcije kalkulatora)
