...
**Vrijeme potrebno**: Cijela radionica može se završiti online bez lokalne instalacije. Postavljanje okruženja traje 2 minute, a istraživanje primjera zahtijeva 1-3 sata ovisno o dubini istraživanja.

> **Brzi početak**

1. Izradi fork ovog repozitorija na svoj GitHub račun
2. Klikni **Code** → kartica **Codespaces** → **...** → **New with options...**
3. Korištenjem zadanih postavki – ovo će odabrati kontejner za razvoj stvoren za ovaj tečaj
4. Klikni **Create codespace**
5. Pričekaj ~2 minute da se okruženje pripremi
6. Odmah prijeđi na [Prvi primjer](./02-SetupDevEnvironment/README.md#step-2-create-a-github-personal-access-token)

> **Radije kloniraš lokalno?**
>
> Ovaj repozitorij uključuje 50+ prijevoda jezika što značajno povećava veličinu preuzimanja. Za kloniranje bez prijevoda, koristi sparse checkout:
> ```bash
> git clone --filter=blob:none --sparse https://github.com/microsoft/Generative-AI-for-beginners-java.git
> cd Generative-AI-for-beginners-java
> git sparse-checkout set --no-cone '/*' '!translations' '!translated_images'
> ```
> Tako dobivaš sve što ti treba za dovršetak tečaja uz znatno brže preuzimanje.
...
- **Konfiguracija više pružatelja**: Postavljanje GitHub modela, Azure OpenAI i integracija OpenAI Java SDK-a
...
- **Inženjering natuknica (promptova)**: Tehnike za optimalne AI model odgovore
- **Ugradnje i vektorske operacije**: Implementacija semantičkog pretraživanja i podudaranja sličnosti
- **Generiranje uz nadopunu pretraživanja (RAG)**: Spojite AI sa vlastitim izvorima podataka
- **Pozivanje funkcija**: Proširite AI sposobnosti prilagođenim alatima i dodacima
...
- **MCP kalkulator servis** (`calculator/`): Osnovna implementacija Model Context Protocol uz Spring AI
- **[→ Počni poglavlje 4](./04-PracticalSamples/README.md)**

### **Poglavlje 5: Odgovoran razvoj umjetne inteligencije**
- **Sigurnost GitHub modela**: Testirajte ugrađeno filtriranje sadržaja i sigurnosne mehanizme (čvrste blokade i blage odbijanja)
- **Demo odgovornog AI-ja**: Praktični primjer kako suvremeni AI sigurnosni sustavi funkcioniraju u praksi
- **Najbolje prakse**: Bitne smjernice za etički razvoj i implementaciju AI-ja
