...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-04T07:00:35+00:00",
...
இந்த பயிற்சியை தொடங்குவதற்கு முன், உங்களிடம் இருக்க வேண்டும்:
...
4. **pom.xml** - Maven சார்புகள் மற்றும் திட்ட கட்டமைப்பு
...
**இதன் செயல்பாடு:**
- **base-url**: Foundry Local இயங்கும் இடத்தை குறிப்பிடுகிறது, `/v1` பாதை OpenAI API இணக்கத்திற்காக சேர்க்கப்பட்டுள்ளது. **குறிப்பு**: Foundry Local தானாகவே ஒரு போர்ட்டை ஒதுக்குகிறது, எனவே `foundry service status` மூலம் உங்கள் போர்ட்டை சரிபார்க்கவும்
- **model**: உரை உருவாக்கத்திற்கான AI மாடலை பெயரிடுகிறது, பதிப்பு எண்ணை உட்படுத்தி (எ.கா., `:1`). `foundry model list` மூலம் கிடைக்கக்கூடிய மாடல்களை மற்றும் அவற்றின் சரியான ஐடிகளை பார்க்கவும்
...
**இதன் செயல்பாடு:**
- `@SpringBootApplication` Spring Boot தானியக்க-கட்டமைப்பை இயக்குகிறது
...
**இதன் செயல்பாடு:**
- `@Service` Spring இந்த வகுப்பு வணிக தர்க்கத்தை வழங்குகிறது என்பதைச் சொல்கிறது
- `@Value` application.properties-இல் இருந்து கட்டமைப்பு மதிப்புகளை செலுத்துகிறது
- `:default-value` சSyntax பண்புகள் அமைக்கப்படவில்லை என்றால் பின்வாங்க மதிப்புகளை வழங்குகிறது
...
- உங்கள் உள்ளூர் Foundry Local instance-க்கு பாயிண்ட் செய்யும் OpenAI கிளையன்டை உருவாக்குகிறது
- `application.properties`-இல் இருந்து base URL ஏற்கனவே OpenAI API இணக்கத்திற்காக `/v1` உட்படுத்துகிறது
...
- **ChatCompletionCreateParams**: AI கோரிக்கையை அமைக்கிறது
  - `model`: எந்த AI மாடலை பயன்படுத்த வேண்டும் என்பதை குறிப்பிடுகிறது (`foundry model list`-இல் இருந்து சரியான ஐடியுடன் பொருந்த வேண்டும்)
  - `addUserMessage`: உங்கள் செய்தியை உரையாடலுக்கு சேர்க்கிறது
  - `maxCompletionTokens`: பதில் எவ்வளவு நீளமாக இருக்க வேண்டும் என்பதை வரையறுக்கிறது (வளங்களை சேமிக்கிறது)
...
- **பிழை கையாளுதல்**: உதவிகரமான பிழை செய்திகளுடன் விதிவிலக்குகளை சுற்றுகிறது
...
- **jackson-databind**: API அழைப்புகளுக்கான JSON serialization/deserialization கையாளுகிறது

## எல்லாம் ஒன்றாக எப்படி வேலை செய்கிறது

நீங்கள் பயன்பாட்டை இயக்கும்போது முழு செயல்முறை இதுதான்:

1. **தொடக்கம்**: Spring Boot தொடங்கி `application.properties`-ஐ படிக்கிறது
2. **சேவை உருவாக்கம்**: Spring `FoundryLocalService`-ஐ உருவாக்கி கட்டமைப்பு மதிப்புகளை செலுத்துகிறது
...
7. **பதில் செயலாக்கம்**: சேவை பதிலை எடுத்து திரும்ப வழங்குகிறது
8. **காட்டுதல்**: பயன்பாடு பதிலை அச்சிட்டு வெளியேறுகிறது

## Foundry Local அமைத்தல்

Foundry Local-ஐ அமைக்க, இந்த படிகளை பின்பற்றவும்:

1. **Foundry Local-ஐ நிறுவவும்** [Prerequisites](../../../../04-PracticalSamples/foundrylocal) பிரிவில் உள்ள வழிமுறைகளைப் பயன்படுத்தி.

2. **தானாக ஒதுக்கப்பட்ட போர்ட்டை சரிபார்க்கவும்**. Foundry Local தானாகவே ஒரு போர்ட்டை ஒதுக்குகிறது. உங்கள் போர்ட்டை கண்டறிய:
   ```bash
   foundry service status
   ```
   
   **விருப்பம்**: நீங்கள் ஒரு குறிப்பிட்ட போர்ட்டை (எ.கா., 5273) பயன்படுத்த விரும்பினால், அதை கையேடாக அமைக்கலாம்:
   ```bash
   foundry service set --port 5273
   ```

3. **உங்கள் பயன்படுத்த விரும்பும் AI மாடலை பதிவிறக்கவும்**, உதாரணமாக, `phi-3.5-mini`, கீழே உள்ள கட்டளையைப் பயன்படுத்தி:
   ```bash
   foundry model run phi-3.5-mini
   ```

4. **application.properties** கோப்பை உங்கள் Foundry Local அமைப்புகளுக்கு பொருந்துமாறு அமைக்கவும்:
   - `base-url`-இல் போர்ட்டை (படி 2-இல் இருந்து) புதுப்பிக்கவும், `/v1` இறுதியில் சேர்க்கப்பட்டிருக்க வேண்டும்
   - மாடல் பெயரை பதிப்பு எண்ணுடன் புதுப்பிக்கவும் (`foundry model list` மூலம் சரிபார்க்கவும்)
...
- Foundry Local பயன்படுத்தும் போர்ட்டை சரிபார்க்கவும்: `foundry service status`
- உங்கள் `application.properties`-ஐ சரியான போர்ட்டுடன் புதுப்பிக்கவும், URL `/v1`-இல் முடிவடைய வேண்டும்
...
- கிடைக்கக்கூடிய மாடல்களை மற்றும் அவற்றின் சரியான ஐடிகளை சரிபார்க்கவும்: `foundry model list`
- `application.properties`-இல் மாடல் பெயரை சரியாக புதுப்பிக்கவும், பதிப்பு எண்ணை உட்படுத்தி (எ.கா., `Phi-3.5-mini-instruct-cuda-gpu:1`)
- `base-url` `/v1`-இல் முடிவடைய வேண்டும் என்பதை உறுதிப்படுத்தவும்: `http://localhost:5273/v1`
- தேவையான மாடலை பதிவிறக்கவும்: `foundry model run phi-3.5-mini`

**"400 Bad Request" பிழைகள்**
- `base-url` `/v1`-ஐ உட்படுத்துகிறது என்பதை உறுதிப்படுத்தவும்: `http://localhost:5273/v1`
- மாடல் ஐடி `foundry model list`-இல் காட்டப்படுவதுடன் சரியாக பொருந்துகிறது என்பதை சரிபார்க்கவும்
- உங்கள் குறியீட்டில் `maxCompletionTokens()` பயன்படுத்துகிறீர்கள் என்பதை உறுதிப்படுத்தவும் (முந்தைய `maxTokens()` பயன்படுத்த வேண்டாம்)
...
- மாடல் முழுமையாக ஏற்றப்பட்டு தயாராக இருக்கிறதா என்பதை உறுதிப்படுத்தவும்
