...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-17T14:53:35+00:00",
...
**நேர ஒதுக்கீடு**: முழு பணிமனை ஆன்லைனில் உள்ளூர் அமைப்பின்றி முடிக்கலாம். சூழல் அமைப்பு 2 நிமிடங்கள் எடுக்கும், மாதிரிகளை ஆராய 1-3 மணி நேரம் தேவைப்படும், ஆராய்ச்சி ஆழத்தின்படி.
...
6. நேரடியாக [முதல் உதாரணத்திற்கு](./02-SetupDevEnvironment/README.md#step-2-create-a-github-personal-access-token) செல்லவும்

## பல மொழி ஆதரவு

### GitHub Action மூலம் ஆதரவு (தானியங்கி மற்றும் எப்போதும் புதுப்பிக்கப்படும்)
...
- **ஜாவா AI சூழல்**: Spring AI மற்றும் OpenAI SDK களின் மேற்பார்வை
...
- **பல வழங்குநர் கட்டமைப்பு**: GitHub மாதிரிகள், Azure OpenAI மற்றும் OpenAI Java SDK ஒருங்கிணைப்புகள் அமைத்தல்
- **Spring Boot + Spring AI**: நிறுவன AI பயன்பாட்டு மேம்பாட்டுக்கான சிறந்த நடைமுறைகள்
- **GitHub மாதிரிகள்**: மாதிரிப்படுத்தல் மற்றும் கற்றலுக்கான இலவச AI மாதிரி அணுகல் (கடன் அட்டை தேவையில்லை)
- **மேம்பாட்டு கருவிகள்**: Docker கன்டெய்னர்கள், VS Code மற்றும் GitHub Codespaces அமைப்பு
...
- **திரும்ப பெறுதல்-வலுப்படுத்தப்பட்ட உருவாக்கம் (RAG)**: உங்கள் சொந்த தரவுத்தளங்களுடன் AI ஐ இணைத்தல்
...
- **பேட் கதை உருவாக்கி** (`petstory/`): GitHub மாதிரிகளுடன் படைப்பாற்றல் உள்ளடக்க உருவாக்கம்
...
- **GitHub மாதிரிகள் பாதுகாப்பு**: உள்ளடக்க வடிகட்டல் மற்றும் பாதுகாப்பு முறைகள் (கடுமையான தடைகள் மற்றும் மென்மையான மறுப்பு) சோதனை
...
AI செயலிகளை உருவாக்குவதில் நீங்கள் சிக்கிக்கொண்டால் அல்லது ஏதேனும் கேள்விகள் இருந்தால், MCP பற்றி விவாதங்களில் பங்கேற்க fellow learners மற்றும் அனுபவமிக்க டெவலப்பர்களுடன் சேருங்கள். கேள்விகள் வரவேற்கப்படுகின்றன மற்றும் அறிவு சுதந்திரமாக பகிரப்படுகிறது என்ற ஆதரவான சமூகமாக இது உள்ளது.
