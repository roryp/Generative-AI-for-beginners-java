...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-21T20:19:24+00:00",
...
- [Susunod na Hakbang](../../../01-IntroToGenAI)  
...
Ang Generative AI ay isang uri ng artificial intelligence na lumilikha ng bagong content, tulad ng text, larawan, o code, batay sa mga pattern at relasyon na natutunan mula sa data. Ang mga generative AI models ay maaaring bumuo ng mga tugon na parang gawa ng tao, maunawaan ang konteksto, at minsan ay makalikha ng content na tila gawa ng tao.
...
- **Assistant prompts**: Ang mga tugon ng model batay sa system at user prompts  
...
![Figure: Halimbawa ng Generative AI tokens na nagbe-break ng mga salita sa tokens](../../../01-IntroToGenAI/images/tokens.webp)

Ang tokenization ay ang proseso ng pag-breakdown ng text sa mas maliliit na yunit. Mahalaga ito dahil ang mga models ay gumagana sa tokens sa halip na raw text. Ang bilang ng tokens sa isang prompt ay nakakaapekto sa haba at kalidad ng tugon ng model, dahil may token limits ang mga models para sa kanilang context window (hal., 128K tokens para sa kabuuang konteksto ng GPT-4o, kabilang ang input at output).

  Sa Java, maaari mong gamitin ang mga libraries tulad ng OpenAI SDK upang awtomatikong mag-handle ng tokenization kapag nagpapadala ng requests sa AI models.

- **Embeddings**: Ang embeddings ay mga vector representations ng tokens na naglalaman ng semantic meaning. Ito ay mga numerical representations (karaniwang arrays ng floating-point numbers) na nagpapahintulot sa models na maunawaan ang relasyon sa pagitan ng mga salita at makabuo ng contextually relevant na tugon. Ang mga salitang magkatulad ay may magkatulad na embeddings, na nagpapahintulot sa model na maunawaan ang mga konsepto tulad ng synonyms at semantic relationships.

![Figure: Embeddings](../../../translated_images/embedding.398e50802c0037f931c725fd0113747831ea7776434d2b3ba3eb2e7a1a20ab1f.tl.png)

  Sa Java, maaari kang mag-generate ng embeddings gamit ang OpenAI SDK o iba pang libraries na sumusuporta sa embedding generation. Ang mga embeddings ay mahalaga para sa mga tasks tulad ng semantic search, kung saan nais mong makahanap ng katulad na content batay sa kahulugan sa halip na eksaktong text matches.

- **Vector databases**: Ang vector databases ay mga specialized storage systems na na-optimize para sa embeddings. Pinapadali nito ang efficient similarity search at mahalaga para sa Retrieval-Augmented Generation (RAG) patterns kung saan kailangan mong makahanap ng relevant na impormasyon mula sa malalaking datasets batay sa semantic similarity sa halip na eksaktong matches.
...
![Figure: Paano nagiging tugon ang isang prompt—tokens, vectors, optional RAG lookup, LLM thinking, at isang MCP agent sa isang mabilis na flow.](../../../translated_images/flow.f4ef62c3052d12a88b1d216eb2cd0e2ea3293c806d0defa7921dd1786dcb8516.tl.png)
...
Sa Kabanata 4, bubuo ka ng isang simpleng MCP calculator service na nagpapakita ng mga pundasyon ng Model Context Protocol gamit ang Spring AI, na nagpapakita kung paano gumawa ng basic tool integrations at service architectures.
...
- **Natutunan ang mga pangunahing kaalaman sa Generative AI** kabilang ang LLMs, prompt engineering, tokens, embeddings, at vector databases  
- **Ikinumpara ang mga Java AI development tools** tulad ng Azure OpenAI SDK, Spring AI, at OpenAI Java SDK  
