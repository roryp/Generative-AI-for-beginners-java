...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-17T14:42:12+00:00",
...
**Време за ангажиране**: Целият уъркшоп може да бъде завършен онлайн без локална настройка. Настройката на средата отнема 2 минути, а разглеждането на примерите изисква 1-3 часа в зависимост от дълбочината на изследване.
...
- **Основни концепции**: Разбиране на големите езикови модели, токени, вграждания и възможности на AI
...
- **Проектиране на заявки (Prompt Engineering)**: Техники за оптимални отговори от AI моделите
...
- **Безопасност на GitHub Models**: Тествайте вграденото филтриране на съдържание и механизми за безопасност (твърди блокировки и меки откази)
...
Ако заседнете или имате въпроси относно създаването на AI приложения. Присъединете се към други учащи и опитни разработчици в дискусии за MCP. Това е подкрепяща общност, където въпросите са добре дошли и знанието се споделя свободно.
