...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-03T20:03:21+00:00",
...
- [कोड समजून घेणे](../../../../04-PracticalSamples/foundrylocal)
  ...
  - [4. प्रकल्प अवलंबित्वे (pom.xml)](../../../../04-PracticalSamples/foundrylocal)
...
**हे काय करते:**
- **base-url**: फाउंड्री लोकल कुठे चालू आहे हे निर्दिष्ट करते, ज्यामध्ये OpenAI API सुसंगततेसाठी `/v1` पथ समाविष्ट आहे. **टीप**: फाउंड्री लोकल डायनॅमिक पोर्ट नियुक्त करते, त्यामुळे `foundry service status` वापरून तुमचा वास्तविक पोर्ट तपासा.
- **model**: मजकूर निर्मितीसाठी वापरण्यासाठी एआय मॉडेलचे नाव, ज्यामध्ये आवृत्ती क्रमांक (उदा., `:1`) समाविष्ट आहे. उपलब्ध मॉडेल्स आणि त्यांचे अचूक आयडी पाहण्यासाठी `foundry model list` वापरा.
...
जेव्हा तुम्ही अनुप्रयोग चालवता तेव्हा संपूर्ण प्रवाह येथे आहे:
...
5. **एआय कॉल**: डेमो चाचणी संदेशासह `foundryLocalService.chat()` कॉल करते
6. **API विनंती**: सेवा OpenAI-सुसंगत विनंती फाउंड्री लोकलला पाठवते
7. **प्रतिसाद प्रक्रिया**: सेवा एआयचा प्रतिसाद काढते आणि परत करते
...
1. [पूर्वतयारी](../../../../04-PracticalSamples/foundrylocal) विभागातील सूचनांचा वापर करून **फाउंड्री लोकल स्थापित करा**.

2. **डायनॅमिकली नियुक्त पोर्ट तपासा**. फाउंड्री लोकल सुरू झाल्यावर आपोआप पोर्ट नियुक्त करते. तुमचा पोर्ट शोधण्यासाठी:
   ```bash
...
4. **application.properties फाइल कॉन्फिगर करा** तुमच्या फाउंड्री लोकल सेटिंग्जशी जुळण्यासाठी:
   ...
   - मॉडेलचे नाव आवृत्ती क्रमांकासह अपडेट करा (`foundry model list` वापरून तपासा)
...
- तुमच्या `application.properties` मध्ये योग्य पोर्ट अपडेट करा, याची खात्री करा की URL शेवटी `/v1` ने समाप्त होते
- पर्यायी: विशिष्ट पोर्ट सेट करा जर हवे असेल: `foundry service set --port 5273`
...
- मॉडेलचे नाव `application.properties` मध्ये अचूकपणे अपडेट करा, ज्यामध्ये आवृत्ती क्रमांक (उदा., `Phi-3.5-mini-instruct-cuda-gpu:1`) समाविष्ट आहे
- `base-url` मध्ये शेवटी `/v1` समाविष्ट असल्याची खात्री करा: `http://localhost:5273/v1`
- आवश्यक असल्यास मॉडेल डाउनलोड करा: `foundry model run phi-3.5-mini`

**"400 Bad Request" त्रुटी**
- बेस URL मध्ये `/v1` समाविष्ट असल्याची खात्री करा: `http://localhost:5273/v1`
- मॉडेल आयडी अचूकपणे `foundry model list` मध्ये दाखवलेल्या आयडीशी जुळत असल्याची खात्री करा
- तुमच्या कोडमध्ये `maxTokens()` ऐवजी `maxCompletionTokens()` वापरत असल्याची खात्री करा
...
- फाउंड्री लोकल प्रतिसाद देत आहे याची खात्री करा: `http://localhost:5273` ब्राउझरमध्ये उघडा
