...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-21T17:55:53+00:00",
...
- AI अनुप्रयोगांसाठी जावा विकास वातावरण सेट करणे
- तुमचे पसंतीचे विकास वातावरण निवडणे आणि कॉन्फिगर करणे (Codespaces सह क्लाउड-फर्स्ट, स्थानिक dev कंटेनर, किंवा पूर्ण स्थानिक सेटअप)
- GitHub मॉडेल्सशी कनेक्ट करून तुमचे सेटअप तपासणे
...
हे प्रकरण तुम्हाला विकास वातावरण सेट करण्यासाठी मार्गदर्शन करेल. आम्ही **GitHub मॉडेल्स** मुख्य उदाहरण म्हणून वापरणार आहोत कारण ते विनामूल्य आहे, फक्त GitHub खात्यासह सेट करणे सोपे आहे, क्रेडिट कार्ड आवश्यक नाही आणि प्रयोगासाठी अनेक मॉडेल्स उपलब्ध करून देते.
...
- **सोपे** फक्त GitHub खात्यासह सेट करणे
...
आम्ही या जनरेटिव AI साठी जावा कोर्ससाठी आवश्यक सर्व साधने आणि साधनांसह सेटअप वेळ कमी करण्यासाठी पूर्व-कॉन्फिगर केलेले विकास कंटेनर तयार केले आहे. तुमचा पसंतीचा विकास दृष्टिकोन निवडा:
...
> - सर्व साधने आणि dependencies सह पूर्व-कॉन्फिगर केलेले
...
> **प्रो टिप**: जर तुमच्याकडे कमी-विशिष्ट मशीन असेल पण तुम्हाला स्थानिक VS Code हवे असेल, तर GitHub Codespaces वापरा! तुम्ही तुमच्या स्थानिक VS Code ला क्लाउड-होस्टेड Codespace शी कनेक्ट करू शकता.

<img src="./images/image-2.png" alt="स्क्रीनशॉट: स्थानिक devcontainer उदाहरण तयार केले" width="50%">
...
तुमचे विकास वातावरण तयार झाल्यावर, GitHub मॉडेल्ससह आमच्या उदाहरण अनुप्रयोगासह एक चाचणी करूया [`02-SetupDevEnvironment/src/github-models`](../../../02-SetupDevEnvironment/src/github-models) मध्ये.
...
प्रथम, आपण काय चालवणार आहोत ते समजून घेऊया. उदाहरण OpenAI Java SDK वापरते GitHub मॉडेल्सशी कनेक्ट करण्यासाठी:

**हे कोड काय करते:**
- तुमच्या वैयक्तिक प्रवेश टोकनचा वापर करून GitHub मॉडेल्सशी **कनेक्ट** होते
- AI मॉडेलला एक साधा "Say Hello World!" संदेश **पाठवते**
- AI चा प्रतिसाद **प्राप्त** करते आणि प्रदर्शित करते
- तुमचे सेटअप योग्यरित्या कार्यरत आहे की नाही हे **सत्यापित** करते
...
- **तुमचे जावा विकास वातावरण सेट केले** Codespaces, dev कंटेनर किंवा स्थानिक स्थापनेचा वापर करून
- **GitHub मॉडेल्सशी कनेक्ट केले** OpenAI Java SDK वापरून विनामूल्य AI विकास प्रवेशासाठी
- **एकत्रीकरणाची चाचणी केली** कार्यरत उदाहरण अनुप्रयोगासह जो AI मॉडेल्सशी संवाद साधतो
...
- **टोकन कार्य करत नाही?** 
  - तुम्ही संपूर्ण टोकन कोणत्याही अतिरिक्त जागेशिवाय कॉपी केले आहे याची खात्री करा
...
- **Maven सापडत नाही?** 
  - dev कंटेनर/Codespaces वापरत असल्यास, Maven पूर्व-स्थापित असले पाहिजे
