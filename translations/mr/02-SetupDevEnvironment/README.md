...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-29T08:45:41+00:00",
  "source_file": "02-SetupDevEnvironment/README.md",
  "language_code": "mr"
}
-->
# जावा साठी जनरेटिव्ह AI विकास वातावरण सेट करणे
...
हे प्रकरण तुम्हाला विकास वातावरण सेट करण्यासाठी मार्गदर्शन करेल. आम्ही **GitHub मॉडेल्स** मुख्य उदाहरण म्हणून वापरणार आहोत कारण ते विनामूल्य आहे, फक्त GitHub खात्यासह सेट करणे सोपे आहे, क्रेडिट कार्ड आवश्यक नाही आणि प्रयोगासाठी अनेक मॉडेल्समध्ये प्रवेश प्रदान करते.
...
> - सर्व साधने आणि अवलंबित्वांसह प्री-कॉन्फिगर केलेले
...
2. डाव्या साइडबारमध्ये, **Developer settings** (सामान्यतः तळाशी) वर क्लिक करा.
...
6. समाप्ती तारीख सेट करा (सुरक्षेसाठी शिफारस केलेली: 7 दिवस).
...
तुमचे विकास वातावरण तयार झाल्यावर, आमच्या उदाहरण अनुप्रयोगासह GitHub मॉडेल्स एकत्रीकरण तपासूया [`02-SetupDevEnvironment/examples/github-models`](../../../02-SetupDevEnvironment/examples/github-models) मध्ये.
...
**हा कोड काय करतो:**
- तुमच्या वैयक्तिक प्रवेश टोकन वापरून GitHub मॉडेल्सशी **कनेक्ट** करतो
- AI मॉडेलला एक साधा "Say Hello World!" संदेश **पाठवतो**
- AI चा प्रतिसाद **प्राप्त** करतो आणि प्रदर्शित करतो
- तुमचे सेटअप योग्यरित्या कार्य करत आहे हे **सत्यापित** करतो

**मुख्य अवलंबित्व** (`pom.xml` मध्ये):
```xml
<dependency>
...
छान! तुम्ही आता सर्व सेट केले आहे:
...
- AI मॉडेल्सशी संवाद साधणारे एक साधे उदाहरण चालवून सर्व काही तपासले
...
- **Maven सापडत नाही?** 
  ...
  - स्थापना सत्यापित करण्यासाठी `mvn --version` वापरा
