...
**Compromisso de Tempo**: O workshop completo pode ser realizado online sem necessidade de configuração local. A configuração do ambiente demora 2 minutos, e explorar os exemplos requer entre 1-3 horas, dependendo da profundidade da exploração.
...
>
> Este repositório inclui mais de 50 traduções de idioma que aumentam significativamente o tamanho do download. Para clonar sem traduções, utilize checkout esparso:
>
> **Linux / macOS (Bash)**
> ```bash
...
- **Conceitos Principais**: Compreender Modelos de Linguagem Grandes, tokens, embeddings e capacidades de IA
...
- **Configuração Multi-Provedor**: Configurar integrações dos GitHub Models, Azure OpenAI e OpenAI Java SDK
- **Spring Boot + Spring AI**: Melhores práticas para desenvolvimento de aplicações empresariais de IA
- **GitHub Models**: Acesso gratuito a modelos IA para prototipagem e aprendizagem (sem necessidade de cartão de crédito)
...
- **Chamadas de Funções**: Expandir capacidades de IA com ferramentas e plugins personalizados
...
- **Demo Local Foundry** (`foundrylocal/`): Integração local de modelo IA com OpenAI Java SDK
...
- **Segurança nos GitHub Models**: Testar filtragem de conteúdo e mecanismos de segurança incorporados (bloqueios rígidos e recusas suaves)
- **Demo de IA Responsável**: Exemplo prático mostrando como funcionam os sistemas modernos de segurança em IA
...
Se ficar retido ou tiver alguma questão sobre como criar aplicações de IA. Junte-se a outros aprendizes e desenvolvedores experientes em discussões sobre MCP. É uma comunidade de apoio onde as perguntas são bem-vindas e o conhecimento é partilhado livremente.
