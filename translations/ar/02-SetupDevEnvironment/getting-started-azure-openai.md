...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-21T18:00:07+00:00",
...
3. قم بتكوين المركز الخاص بك:
   - **اسم المركز**: على سبيل المثال، "MyAIHub"
   - **الاشتراك**: اختر اشتراك Azure الخاص بك
   - **مجموعة الموارد**: أنشئ مجموعة جديدة أو اختر مجموعة موجودة
...
4. بمجرد الإنشاء، انقر على **+ مشروع جديد** (أو **إنشاء مشروع** من نظرة عامة على المركز)
   - **اسم المشروع**: على سبيل المثال، "GenAIJava"
   - انقر على **إنشاء**
...
5. بمجرد النشر، انتقل إلى علامة تبويب **النشر** ونسخ القيم التالية:
   - **اسم النشر** (على سبيل المثال، "gpt-4o-mini")
   - **عنوان URI الهدف** (على سبيل المثال، `https://your-hub-name.openai.azure.com/`) 
      > **هام**: انسخ فقط عنوان URL الأساسي (على سبيل المثال، `https://myhub.openai.azure.com/`) وليس المسار الكامل لنقطة النهاية.
...
قم بتشغيل التطبيق النموذجي لاختبار اتصال Azure OpenAI:
...
> **مثال كامل**: راجع [مثال Azure OpenAI من البداية إلى النهاية](./src/basic-chat-azure/README.md) للحصول على تعليمات مفصلة وحل المشكلات.
