...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-27T12:51:24+00:00",
...
هذا الفصل سيرشدك خلال إعداد بيئة التطوير. سنستخدم **نماذج GitHub** كمثال رئيسي لأنها مجانية، سهلة الإعداد باستخدام حساب GitHub فقط، لا تتطلب بطاقة ائتمان، وتوفر الوصول إلى نماذج متعددة للتجربة.
...
> **ملاحظة**: نماذج GitHub المستخدمة في هذا التدريب لديها الحدود المجانية التالية:
...
لقد أنشأنا حاوية تطوير مهيأة مسبقًا لتقليل وقت الإعداد وضمان توفر جميع الأدوات اللازمة لهذه الدورة الخاصة بالذكاء الاصطناعي التوليدي باستخدام Java. اختر نهج التطوير المفضل لديك:
...
3. استخدم الإعدادات الافتراضية – سيختار هذا **تكوين حاوية التطوير**: **بيئة تطوير Java للذكاء الاصطناعي التوليدي** حاوية التطوير المخصصة التي تم إنشاؤها لهذه الدورة
...
> **نصيحة احترافية**: إذا كان لديك جهاز منخفض المواصفات ولكنك تريد VS Code محليًا، استخدم GitHub Codespaces! يمكنك ربط VS Code المحلي الخاص بك بـ Codespace مستضاف في السحابة للحصول على أفضل ما في العالمين.
...
بمجرد أن تكون بيئة التطوير جاهزة، دعنا نختبر تكامل نماذج GitHub مع تطبيق المثال الخاص بنا في [`02-SetupDevEnvironment/examples/github-models`](../../../02-SetupDevEnvironment/examples/github-models).
