...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-27T08:32:27+00:00",
...
**مدة الالتزام**: يمكن إكمال الورشة بالكامل عبر الإنترنت دون الحاجة إلى إعداد محلي. إذا كنت ترغب في تشغيل الأمثلة، فإن إعداد البيئة يستغرق دقيقتين، واستكشاف الأمثلة يتطلب من 1-3 ساعات حسب عمق الاستكشاف.
...
- **نظام الذكاء الاصطناعي في Java**: نظرة عامة على Spring AI وOpenAI SDKs  
