...
**الوقت المطلوب**: يمكن إتمام الورشة بالكامل عبر الإنترنت دون إعداد محلي. يستغرق إعداد البيئة دقيقتين، مع استكشاف العينات يتطلب من 1 إلى 3 ساعات حسب عمق الاستكشاف.

> **البدء السريع** 

1. استنسخ هذا المستودع إلى حسابك على GitHub
2. اضغط على **Code** → علامة تبويب **Codespaces** → **...** → **جديد مع خيارات...**
3. استخدم الإعدادات الافتراضية – هذا سيختار حاوية التطوير المخصصة لهذه الدورة
4. اضغط **إنشاء مساحة رمز**
...
> **تفضل النسخ محليًا؟**
>
> يحتوي هذا المستودع على أكثر من 50 ترجمة لغة مما يزيد بشكل كبير حجم التنزيل. لاستنساخ دون الترجمات، استخدم الاستنساخ الجزئي:
> ```bash
...
### مدعوم عبر GitHub Action (آلي وعلى الدوام محدث)
...
- **نظام الذكاء الاصطناعي في جافا**: نظرة عامة على Spring AI وOpenAI SDKs
...
- **تكوين متعدد المزودين**: إعداد نماذج GitHub وAzure OpenAI وOpenAI Java SDK
...
- **أدوات التطوير**: حاويات Docker، VS Code، وإعداد GitHub Codespaces
- **[→ ابدأ الفصل 2](./02-SetupDevEnvironment/README.md)**

### **الفصل 3: تقنيات الذكاء الاصطناعي التوليدي الأساسية**
- **هندسة الموجهات**: تقنيات للحصول على استجابات مثالية من نماذج الذكاء الاصطناعي
- **التضمينات والعمليات الموجهة**: تنفيذ البحث الدلالي ومطابقة التشابه
- **التوليد المدعوم بالاستخراج (RAG)**: دمج الذكاء الاصطناعي مع مصادر بياناتك الخاصة
...
- **عرض Foundry المحلي** (`foundrylocal/`): دمج نموذج الذكاء الاصطناعي المحلي باستخدام OpenAI Java SDK
...
- **سلامة نماذج GitHub**: اختبار آليات تصفية المحتوى والسلامة المدمجة (الحجب الصارم والرفض اللين)
...
[![الوكلاء الذكاء الاصطناعي للمبتدئين](https://img.shields.io/badge/AI%20Agents%20for%20Beginners-00C49A?style=for-the-badge&labelColor=E5E7EB&color=00C49A)](https://github.com/microsoft/ai-agents-for-beginners?WT.mc_id=academic-105485-koreyst)
...
### سلسلة المساعد
[![المساعد للبرمجة المزدوجة بالذكاء الاصطناعي](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
...
إذا واجهت صعوبة أو كان لديك أي أسئلة حول بناء تطبيقات الذكاء الاصطناعي. انضم إلى المتعلمين الآخرين والمطورين ذوي الخبرة في مناقشات حول MCP. إنها مجتمع داعم حيث تُرحب الأسئلة وتُشارك المعرفة بحرية.

[![خادم Discord لمايكروسوفت فاوندري](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)

إذا كان لديك ملاحظات على المنتج أو أخطاء أثناء التطوير، قم بزيارة:
