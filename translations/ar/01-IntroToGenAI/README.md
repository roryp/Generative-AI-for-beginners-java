...
![الشكل: أنواع نماذج الذكاء الاصطناعي التوليدي وحالات الاستخدام.](../../../translated_images/llms.225ca2b8a0d34473.ar.png)
...
![الشكل: التضمينات](../../../translated_images/embedding.398e50802c0037f9.ar.png)
...
![الشكل: بنية قاعدة البيانات المتجهية توضح كيفية تخزين التضمينات واسترجاعها للبحث عن التشابه.](../../../translated_images/vector.f12f114934e223df.ar.png)
...
![الشكل: كيف يتحول التوجيه إلى رد—رموز، متجهات، بحث اختياري RAG، تفكير LLM، ووكيل MCP في تدفق سريع واحد.](../../../translated_images/flow.f4ef62c3052d12a8.ar.png)
