...
![الشكل: أنواع نماذج الذكاء الاصطناعي التوليدي وحالات الاستخدام.](../../../translated_images/ar/llms.225ca2b8a0d34473.png)
...
![الشكل: التضمينات](../../../translated_images/ar/embedding.398e50802c0037f9.png)
...
![الشكل: بنية قاعدة البيانات المتجهية توضح كيفية تخزين التضمينات واسترجاعها للبحث عن التشابه.](../../../translated_images/ar/vector.f12f114934e223df.png)
...
![الشكل: كيف يتحول التوجيه إلى رد—رموز، متجهات، بحث اختياري RAG، تفكير LLM، ووكيل MCP في تدفق سريع واحد.](../../../translated_images/ar/flow.f4ef62c3052d12a8.png)
