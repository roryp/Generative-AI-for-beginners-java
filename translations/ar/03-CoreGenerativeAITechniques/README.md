...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-29T08:06:19+00:00",
...
يوضح هذا المثال الآليات الأساسية للتفاعل مع نماذج اللغة الكبيرة (LLM) عبر واجهة برمجة تطبيقات OpenAI، بما في ذلك تهيئة العميل باستخدام نماذج GitHub، وأنماط هيكلة الرسائل للمطالبات النظامية والمستخدم، وإدارة حالة المحادثة من خلال تراكم سجل الرسائل، وضبط المعلمات للتحكم في طول الاستجابة ومستوى الإبداع.
...
1. **وظيفة الطقس**: يطلب الذكاء الاصطناعي بيانات الطقس لمدينة سياتل، تقدمها له، ثم يصيغ استجابة
2. **وظيفة الآلة الحاسبة**: يطلب الذكاء الاصطناعي حساب (15% من 240)، تقوم بحسابه، ثم يشرح الذكاء الاصطناعي النتيجة
...
يوضح مثال الذكاء الاصطناعي المسؤول أهمية تنفيذ تدابير الأمان في تطبيقات الذكاء الاصطناعي. يوضح كيف تعمل أنظمة أمان الذكاء الاصطناعي الحديثة من خلال آليتين رئيسيتين: الحظر الصارم (أخطاء HTTP 400 من مرشحات الأمان) والرفض الناعم (ردود مهذبة مثل "لا يمكنني مساعدتك في ذلك" من النموذج نفسه). يوضح هذا المثال كيفية تعامل تطبيقات الذكاء الاصطناعي الإنتاجية مع انتهاكات سياسة المحتوى من خلال معالجة الاستثناءات بشكل صحيح، واكتشاف الرفض، وآليات ملاحظات المستخدم، واستراتيجيات الاستجابة البديلة.
...
#### 2. فئات الأمان التي تم اختبارها
- تعليمات العنف/الأذى
- خطاب الكراهية
- انتهاكات الخصوصية
...
يختبر البرنامج مطالبات ضارة مختلفة ويظهر كيف يعمل نظام أمان الذكاء الاصطناعي من خلال آليتين:

1. **الحظر الصارم**: أخطاء HTTP 400 عندما يتم حظر المحتوى بواسطة مرشحات الأمان قبل الوصول إلى النموذج
...
هذا يوضح أن **كل من الحظر الصارم والرفض الناعم يشيران إلى أن نظام الأمان يعمل بشكل صحيح**.
