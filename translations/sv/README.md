...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-24T09:07:04+00:00",
...
**Tidsåtgång**: Hela workshopen kan genomföras online utan lokal installation. Att sätta upp miljön tar 2 minuter, och att utforska exemplen tar 1-3 timmar beroende på hur djupt du vill gå.
...
- **Grundläggande koncept**: Förstå stora språkmodeller, tokens, embeddings och AI-funktioner
...
- **Function Calling**: Utöka AI-funktioner med anpassade verktyg och plugins
...
- **MCP Calculator Service** (`calculator/`): Grundläggande implementering av Model Context Protocol med Spring AI
