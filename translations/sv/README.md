...
**Tidsåtgång**: Hela workshoppen kan genomföras online utan lokal installation. Miljöinställningen tar 2 minuter, och att utforska exemplen tar 1-3 timmar beroende på utforskningsdjup.
...
- **Kärnbegrepp**: Förståelse för stora språkmodeller, tokens, embeddings och AI-förmågor
...
- **Multi-leverantörs-konfiguration**: Ställ in GitHub-modeller, Azure OpenAI och OpenAI Java SDK-integrationer
- **Spring Boot + Spring AI**: Bästa praxis för företagsutveckling av AI-applikationer
- **GitHub Models**: Gratis AI-modellantillgång för prototyping och lärande (ingen kreditkort krävs)
...
- **Prompt Engineering**: Tekniker för optimala svar från AI-modeller
...
- **GitHub Models säkerhet**: Testa inbyggda innehållsfiltreringar och säkerhetsmekanismer (hårda blockeringar och mjuka avslag)
- **Ansvarsfull AI-demo**: Praktiskt exempel som visar hur moderna AIsäkerhetssystem fungerar i praktiken
...
Om du kör fast eller har några frågor om att bygga AI-appar. Gå med i diskussioner med andra elever och erfarna utvecklare om MCP. Det är en stödjande gemenskap där frågor är välkomna och kunskap delas fritt.
