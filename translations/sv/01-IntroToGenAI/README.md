...
![Figur: Typer av generativa AI-modeller och användningsområden.](../../../translated_images/sv/llms.225ca2b8a0d34473.png)
...
![Figur: Embeddings](../../../translated_images/sv/embedding.398e50802c0037f9.png)
...
![Figur: Vektordatabasarkitektur som visar hur embeddings lagras och hämtas för likhetssökning.](../../../translated_images/sv/vector.f12f114934e223df.png)
...
![Figur: Hur en prompt blir ett svar—tokens, vektorer, valfri RAG-sökning, LLM-tänkande och en MCP-agent allt i ett snabbt flöde.](../../../translated_images/sv/flow.f4ef62c3052d12a8.png)
