...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-25T11:55:28+00:00",
...
- [Ako všetko spolu funguje](../../../../04-PracticalSamples/petstory)
...
Tento komponent spracováva všetky webové požiadavky a interakcie s používateľom:
...
3. **Bezpečnosť**: Sanitizuje vstupy používateľa na prevenciu XSS útokov
4. **Spracovanie chýb**: Poskytuje náhradné príbehy, keď AI služba zlyhá
...
2. **Systémový prompt**: Nastavuje správanie AI na písanie rodinne priateľských príbehov o domácich miláčikoch
...
2. **Responzívny dizajn**: CSS štýlovanie pre mobilné zariadenia a desktopy
3. **Spracovanie chýb**: Zobrazuje validačné chyby používateľom
4. **Klientské spracovanie**: JavaScript na analýzu obrázkov (pomocou Transformers.js)
...
1. **Nahrávanie súborov**: Povolenie obrázkov do veľkosti 10 MB
...
4. **Bezpečnosť**: Nastavenie spracovania chýb, aby sa predišlo odhaleniu citlivých informácií
...
- Použitie premenných prostredia uchováva citlivé tokeny mimo zdrojového kódu
- Oprávnenie `models:read` umožňuje prístup k AI inferencii
...
2. Vygeneruje náhradný príbeh pomocou predpripravených šablón
3. Zobrazí náhradný príbeh s poznámkou o nedostupnosti AI
4. Používateľ stále dostane príbeh, čo zaručuje dobrú používateľskú skúsenosť
