...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-27T13:24:14+00:00",
...
3. Použite predvolené nastavenia – toto vyberie **Konfiguráciu Dev kontajnera**: **Generative AI Java Development Environment**, vlastný devcontainer vytvorený pre tento kurz
...
1. Prejdite na [Nastavenia GitHub](https://github.com/settings/profile) a vyberte **Settings** z vášho profilového menu.
...
Keď je vaše vývojové prostredie pripravené, otestujme integráciu GitHub modelov s našou ukážkovou aplikáciou v [`02-SetupDevEnvironment/examples/github-models`](../../../02-SetupDevEnvironment/examples/github-models).
...
Najprv si vysvetlíme, čo sme práve spustili. Príklad v `examples/github-models` používa OpenAI Java SDK na pripojenie k GitHub modelom:
