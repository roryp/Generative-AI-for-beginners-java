...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-21T15:51:47+00:00",
...
**Temps requis** : La configuration de l'environnement prend 2 minutes, et les tutoriels pratiques nécessitent 1 à 3 heures chacun selon le niveau d'exploration.
...
- **Sécurité des GitHub Models** : Tester les filtres de contenu intégrés et les mécanismes de sécurité
- **Démo IA Responsable** : Exemple pratique montrant le fonctionnement des filtres de sécurité IA
