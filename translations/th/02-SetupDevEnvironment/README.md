...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-21T19:26:54+00:00",
...
- เลือกและกำหนดค่าการตั้งค่าที่คุณต้องการ (เน้นคลาวด์ด้วย Codespaces, dev container ในเครื่อง, หรือการตั้งค่าในเครื่องเต็มรูปแบบ)
...
บทนี้จะช่วยคุณตั้งค่าสภาพแวดล้อมการพัฒนา เราจะใช้ **GitHub Models** เป็นตัวอย่างหลัก เนื่องจากใช้งานฟรี ตั้งค่าได้ง่ายเพียงแค่มีบัญชี GitHub ไม่ต้องใช้บัตรเครดิต และให้การเข้าถึงโมเดลหลายตัวสำหรับการทดลอง
...
เราได้สร้าง dev container ที่กำหนดค่าไว้ล่วงหน้าเพื่อลดเวลาในการตั้งค่าและให้แน่ใจว่าคุณมีเครื่องมือที่จำเป็นทั้งหมดสำหรับคอร์ส Generative AI ด้วย Java เลือกวิธีการพัฒนาที่คุณต้องการ:
...
1. Fork repository นี้ไปยังบัญชี GitHub ของคุณ
   > **หมายเหตุ**: หากคุณต้องการแก้ไข config พื้นฐาน โปรดดูที่ [Dev Container Configuration](../../../.devcontainer/devcontainer.json)
...
6. ตั้งวันที่หมดอายุ (แนะนำ: 7 วันเพื่อความปลอดภัย)
...
9. ภายใต้ "Repository permissions" หา **Models** และตั้งค่าเป็น **Read and write**
10. คลิก **Generate token**
11. **คัดลอกและบันทึก token ของคุณทันที** – คุณจะไม่สามารถดูได้อีก!

> **เคล็ดลับด้านความปลอดภัย**: ใช้ scope ที่จำเป็นขั้นต่ำและเวลาหมดอายุที่สั้นที่สุดเท่าที่จะเป็นไปได้สำหรับ access token ของคุณ

## ขั้นตอนที่ 3: ทดสอบการตั้งค่าของคุณด้วยตัวอย่าง GitHub Models

เมื่อสภาพแวดล้อมการพัฒนาของคุณพร้อมแล้ว มาทดสอบการเชื่อมต่อ GitHub Models ด้วยแอปพลิเคชันตัวอย่างใน [`02-SetupDevEnvironment/src/github-models`](../../../02-SetupDevEnvironment/src/github-models)
...
ก่อนอื่น มาทำความเข้าใจสิ่งที่เรากำลังจะรัน ตัวอย่างนี้ใช้ OpenAI Java SDK เพื่อเชื่อมต่อกับ GitHub Models:
...
- **ตั้งค่าสภาพแวดล้อมการพัฒนา Java** โดยใช้ Codespaces, dev containers, หรือการติดตั้งในเครื่อง
...
- **Dev container ไม่เริ่มต้น?** 
  - ตรวจสอบว่า Docker Desktop กำลังทำงานอยู่ (สำหรับการพัฒนาในเครื่อง)
  - ลองสร้าง container ใหม่: `Ctrl+Shift+P` → "Dev Containers: Rebuild Container"

- **ข้อผิดพลาดในการคอมไพล์แอปพลิเคชัน?**
  - ตรวจสอบว่าคุณอยู่ในไดเรกทอรีที่ถูกต้อง: `02-SetupDevEnvironment/src/github-models`
