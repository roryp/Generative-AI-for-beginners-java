...
![Figura: Tipos de modelos de IA generativa e casos de uso.](../../../translated_images/br/llms.225ca2b8a0d34473.png)
...
![Figura: Embeddings](../../../translated_images/br/embedding.398e50802c0037f9.png)
...
![Figura: Arquitetura de banco de dados vetorial mostrando como embeddings são armazenados e recuperados para busca por similaridade.](../../../translated_images/br/vector.f12f114934e223df.png)
...
![Figura: como um prompt se torna uma resposta—tokens, vetores, busca opcional RAG, raciocínio LLM e um agente MCP, tudo em um fluxo rápido.](../../../translated_images/br/flow.f4ef62c3052d12a8.png)
