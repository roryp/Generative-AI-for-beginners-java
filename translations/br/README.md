...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T17:13:26+00:00",
...
**Tempo de Dedicação**: Todo o workshop pode ser concluído online sem necessidade de configuração local. A configuração do ambiente leva 2 minutos, e a exploração dos exemplos requer de 1 a 3 horas, dependendo da profundidade de exploração.
...
<!-- FIM DE OUTROS CURSOS DO CO-OP TRANSLATOR -->

## Obtendo Ajuda

Se você ficar preso ou tiver dúvidas sobre como criar aplicativos de IA, junte-se a outros aprendizes e desenvolvedores experientes em discussões sobre MCP. É uma comunidade acolhedora onde perguntas são bem-vindas e o conhecimento é compartilhado livremente.
