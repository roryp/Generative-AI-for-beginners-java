...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-01T08:31:50+00:00",
...
**Tempo de Dedicação**: Todo o workshop pode ser concluído online sem necessidade de configuração local. A configuração do ambiente leva 2 minutos, e a exploração dos exemplos requer de 1 a 3 horas, dependendo da profundidade da exploração.
...
- **Configuração Multi-Provider**: Configure integrações com GitHub Models, Azure OpenAI e OpenAI Java SDK
