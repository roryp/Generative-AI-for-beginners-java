...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-01T08:50:04+00:00",
...
- **Felelős AI bemutató**: Gyakorlati példa, amely bemutatja, hogyan működnek a modern AI biztonsági rendszerek
...
Ha elakadnál, vagy kérdéseid lennének az AI alkalmazások fejlesztésével kapcsolatban, csatlakozz más tanulókhoz és tapasztalt fejlesztőkhöz az MCP-ről szóló beszélgetésekben. Ez egy támogató közösség, ahol szívesen fogadják a kérdéseket, és szabadon osztják meg a tudást.

[![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)

Ha termékvisszajelzést szeretnél adni, vagy hibákba ütközöl a fejlesztés során, látogasd meg:
