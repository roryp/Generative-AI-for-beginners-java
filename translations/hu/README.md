...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-24T09:11:23+00:00",
...
- **Model Context Protocol**: Bevezetés az MCP-be és annak szerepe az AI ügynökök kommunikációjában
...
- **GitHub modellek**: Ingyenes AI modellek elérése prototípusokhoz és tanuláshoz (hitelkártya nem szükséges)
...
- **Beágyazások és vektorműveletek**: Szemantikus keresés és hasonlósági egyezés megvalósítása
...
- **MCP számológép szolgáltatás** (`calculator/`): Alapvető Model Context Protocol megvalósítás a Spring AI segítségével
...
- **Felelős AI demó**: Gyakorlati példa arra, hogyan működnek a modern AI biztonsági rendszerek
...
Ha elakadnál, vagy kérdéseid vannak az AI alkalmazások fejlesztésével kapcsolatban, csatlakozz:

[![Azure AI Foundry Discord](https://img.shields.io/badge/Discord-Azure_AI_Foundry_Community_Discord-blue?style=for-the-badge&logo=discord&color=5865f2&logoColor=fff)](https://aka.ms/foundry/discord)

Ha termékekkel kapcsolatos visszajelzésed van, vagy hibát tapasztalsz a fejlesztés során, látogass el ide:
