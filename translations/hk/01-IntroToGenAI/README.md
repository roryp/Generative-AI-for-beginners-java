...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-29T08:25:46+00:00",
...
- **生成式人工智能基礎**，包括大型語言模型（LLMs）、提示工程、tokens、嵌入（embeddings）以及向量數據庫
...
歡迎來到《生成式人工智能入門 - Java 版》的第一章！這一基礎課程將向你介紹生成式人工智能的核心概念，以及如何使用 Java 與這些概念進行互動。你將學習 AI 應用的基本構建塊，包括大型語言模型（LLMs）、tokens、嵌入以及 AI 代理。我們還將探索你在本課程中使用的主要 Java 工具。

### 生成式人工智能概念快速回顧

生成式人工智能是一種能夠基於從數據中學習到的模式和關係創造新內容（如文本、圖像或代碼）的人工智能。生成式人工智能模型可以生成類似人類的回應、理解上下文，有時甚至能創造看似人類創作的內容。
...
![圖示：生成式人工智能模型類型及其使用案例。](../../../translated_images/zh-HK/llms.225ca2b8a0d34473.webp)
...
> **了解更多**：在[《生成式人工智能入門課程》的提示工程章節](https://github.com/microsoft/generative-ai-for-beginners/tree/main/04-prompt-engineering-fundamentals)中了解更多提示工程內容。
...
![圖示：嵌入](../../../translated_images/zh-HK/embedding.398e50802c0037f9.webp)
...
![圖示：向量數據庫架構，展示嵌入如何存儲和檢索以進行相似性搜索。](../../../translated_images/zh-HK/vector.f12f114934e223df.webp)
...
![圖示：提示如何轉化為回應——tokens、向量、可選的 RAG 查詢、LLM 思考以及 MCP 代理在一個快速流程中的作用。](../../../translated_images/zh-HK/flow.f4ef62c3052d12a8.webp)

### Java 的 AI 開發工具和庫

Java 提供了出色的 AI 開發工具。以下是本課程中將探索的三個主要庫：OpenAI Java SDK、Azure OpenAI SDK 和 Spring AI。
