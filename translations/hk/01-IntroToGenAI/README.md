...
![圖示：生成式人工智能模型類型及其使用案例。](../../../translated_images/hk/llms.225ca2b8a0d34473.webp)
...
![圖示：嵌入](../../../translated_images/hk/embedding.398e50802c0037f9.webp)
...
![圖示：向量數據庫架構，展示嵌入如何存儲和檢索以進行相似性搜索。](../../../translated_images/hk/vector.f12f114934e223df.webp)
...
![圖示：提示如何轉化為回應——tokens、向量、可選的 RAG 查詢、LLM 思考以及 MCP 代理在一個快速流程中的作用。](../../../translated_images/hk/flow.f4ef62c3052d12a8.webp)
