...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T16:59:51+00:00",
...
![初學者生成式 AI - Java 版](../../translated_images/beg-genai-series.8b48be9951cc574c25f8a3accba949bfd03c2f008e2c613283a1b47316fbee68.hk.png)

**所需時間**：整個工作坊可以在線完成，無需本地設置。環境設置只需 2 分鐘，探索範例視乎深度需要 1-3 小時。
...
- **Java AI 生態系統**：Spring AI 和 OpenAI SDKs 概覽
...
如果你遇到困難或對建立 AI 應用程式有任何疑問，可以加入其他學員和有經驗的開發者，參與有關 MCP 的討論。這是一個支持性的社群，歡迎提出問題並自由分享知識。

[![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)

如果你有產品回饋或在開發過程中遇到錯誤，請訪問：
