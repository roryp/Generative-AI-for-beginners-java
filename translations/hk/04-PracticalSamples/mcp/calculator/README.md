...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-25T10:55:13+00:00",
...
這是所有數學運算的核心。每個方法都使用 `@Tool` 註解，讓它可以透過 MCP 被外部客戶端呼叫：
