...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-24T09:11:46+00:00",
...
**Časová náročnost**: Celý workshop lze dokončit online bez nutnosti lokálního nastavení. Nastavení prostředí trvá 2 minuty, prozkoumání příkladů vyžaduje 1-3 hodiny v závislosti na hloubce průzkumu.

> **Rychlý start** 

1. Vytvořte si fork tohoto repozitáře na svém GitHub účtu
...
- **Generátor příběhů o zvířátkách** (`petstory/`): Kreativní generování obsahu s GitHub Models
