...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-25T11:53:17+00:00",
...
1. **Zpracování tras**: `@GetMapping("/")` zobrazí formulář pro nahrávání, `@PostMapping("/generate-story")` zpracovává odeslané údaje
