...
**Czas zaangażowania**: Całe warsztaty można ukończyć online bez lokalnej konfiguracji. Konfiguracja środowiska zajmuje 2 minuty, a eksploracja przykładów wymaga 1-3 godzin w zależności od głębokości eksploracji.
...
> git sparse-checkout set --no-cone "/*" "!translations" "!translated_images"
> ```
> To da Ci wszystko, czego potrzebujesz, aby ukończyć kurs znacznie szybciej pobierając pliki.
...
- **Konfiguracja u wielu dostawców**: Ustawienia GitHub Models, Azure OpenAI i OpenAI Java SDK
- **Spring Boot + Spring AI**: Najlepsze praktyki dla rozwoju aplikacji AI w przedsiębiorstwach
- **GitHub Models**: Bezpłatny dostęp do modeli AI do prototypowania i nauki (bez wymaganej karty kredytowej)
...
- **Inżynieria promptów**: Techniki optymalizacji odpowiedzi modelu AI
- **Osadzenia i operacje na wektorach**: Implementacja semantycznego wyszukiwania i dopasowania podobieństw
- **Generowanie z wzmocnionym przeszukiwaniem (RAG)**: Łączenie AI z własnymi źródłami danych
...
- **Generator historii o zwierzętach** (`petstory/`): Kreatywne generowanie treści z użyciem GitHub Models
- **Lokalna demonstracja Foundry** (`foundrylocal/`): Integracja lokalnego modelu AI z OpenAI Java SDK
...
**Zastrzeżenie**:  
Niniejszy dokument został przetłumaczony przy użyciu usługi tłumaczenia AI [Co-op Translator](https://github.com/Azure/co-op-translator). Choć dokładamy starań, aby tłumaczenie było precyzyjne, prosimy mieć na uwadze, że automatyczne tłumaczenia mogą zawierać błędy lub nieścisłości. Oryginalny dokument w języku źródłowym powinien być uznawany za wiarygodne źródło informacji. W przypadku informacji krytycznych zaleca się skorzystanie z profesjonalnego tłumaczenia wykonanego przez człowieka. Nie ponosimy odpowiedzialności za jakiekolwiek nieporozumienia lub błędne interpretacje wynikające z użycia tego tłumaczenia.
