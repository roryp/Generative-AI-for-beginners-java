...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-28T10:44:07+00:00",
...
- **Konfiguracja Wielu Dostawców**: Ustawienia dla GitHub Models, Azure OpenAI i OpenAI Java SDK
...
- **Kalkulator MCP** (`calculator/`): Podstawowa implementacja Protokółu Kontekstu Modelu z Spring AI
...
- **Demo Odpowiedzialnego AI**: Praktyczny przykład działania filtrów bezpieczeństwa AI
