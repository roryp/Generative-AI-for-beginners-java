...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-27T08:46:46+00:00",
  "source_file": "05-ResponsibleGenAI/README.md",
  "language_code": "pl"
}
-->
# Odpowiedzialna Generatywna Sztuczna Inteligencja
...
Ten ostatni rozdział koncentruje się na kluczowych aspektach budowania odpowiedzialnych i etycznych aplikacji generatywnej AI. Dowiesz się, jak wdrażać środki bezpieczeństwa, obsługiwać filtrowanie treści i stosować najlepsze praktyki w rozwoju odpowiedzialnej AI, korzystając z narzędzi i frameworków omówionych w poprzednich rozdziałach. Zrozumienie tych zasad jest niezbędne do budowania systemów AI, które są nie tylko technicznie zaawansowane, ale także bezpieczne, etyczne i godne zaufania.  

## Wbudowane zabezpieczenia modeli GitHub

Modele GitHub mają wbudowane podstawowe filtrowanie treści. To jak przyjazny bramkarz w twoim klubie AI – może nie jest najbardziej zaawansowany, ale radzi sobie z podstawowymi sytuacjami.  
...
- **Proste próby obejścia zabezpieczeń**: Odpierają podstawowe próby obejścia mechanizmów ochronnych  
...
5. Wyświetla wyniki pokazujące, które treści zostały zablokowane, a które zaakceptowane  
...
1. **Ustaw swój GitHub Personal Access Token:**  
...
Demo przetestuje różne rodzaje potencjalnie szkodliwych zapytań i pokaże:  
...
Podczas budowania aplikacji AI stosuj się do tych kluczowych zasad:  

1. **Zawsze obsługuj odpowiedzi filtrów bezpieczeństwa w odpowiedni sposób**  
   - Wdrażaj odpowiednie mechanizmy obsługi błędów dla zablokowanych treści  
   - Zapewnij użytkownikom znaczące informacje zwrotne, gdy treści są filtrowane  
...
3. **Edukowanie użytkowników na temat odpowiedzialnego korzystania z AI**  
   - Zapewnij jasne wytyczne dotyczące akceptowalnego użytkowania  
...
5. **Przestrzegaj zasad dotyczących treści platformy**  
   ...
   - Przestrzegaj warunków korzystania z usługi i wytycznych etycznych  
...
Ukończyłeś kurs Generative AI for Beginners - Java Edition i jesteś teraz gotowy do budowania bezpiecznych i skutecznych aplikacji AI!  

## Zakończenie kursu

Gratulacje z okazji ukończenia kursu Generative AI for Beginners! Teraz posiadasz wiedzę i narzędzia potrzebne do budowania odpowiedzialnych i skutecznych aplikacji generatywnej AI z wykorzystaniem Javy.  
...
Kontynuuj swoją podróż edukacyjną w dziedzinie AI, korzystając z tych dodatkowych zasobów:  
