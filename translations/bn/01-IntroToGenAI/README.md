...
![চিত্র: জেনারেটিভ এআই মডেলের ধরন এবং ব্যবহার ক্ষেত্র।](../../../translated_images/llms.225ca2b8a0d34473.bn.png)
...
![চিত্র: এমবেডিং](../../../translated_images/embedding.398e50802c0037f9.bn.png)
...
![চিত্র: ভেক্টর ডেটাবেস আর্কিটেকচার যেখানে এমবেডিং সাদৃশ্য অনুসন্ধানের জন্য সংরক্ষণ এবং পুনরুদ্ধার করা হয়।](../../../translated_images/vector.f12f114934e223df.bn.png)
...
![চিত্র: কীভাবে একটি প্রম্পট একটি প্রতিক্রিয়ায় পরিণত হয়—টোকেন, ভেক্টর, ঐচ্ছিক RAG অনুসন্ধান, LLM চিন্তা, এবং MCP এজেন্ট সব এক দ্রুত প্রবাহে।](../../../translated_images/flow.f4ef62c3052d12a8.bn.png)
