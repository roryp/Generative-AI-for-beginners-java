...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-29T08:39:53+00:00",
  "source_file": "README.md",
  "language_code": "bn"
}
-->
# জেনারেটিভ এআই ফর বিগিনারস - জাভা এডিশন
...
### **চ্যাপ্টার ৩: জেনারেটিভ এআই এর মূল কৌশল**
...
- **Retrieval-Augmented Generation (RAG)**: এআই এর সাথে আপনার নিজস্ব ডেটা সোর্স সংযুক্ত করা
