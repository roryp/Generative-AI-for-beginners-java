...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-23T12:07:27+00:00",
...
> **Azure OpenAI এ আগ্রহী?**, আমাদের [Azure OpenAI Setup Guide](getting-started-azure-openai.md) দেখুন যেখানে নতুন Azure OpenAI রিসোর্স তৈরি করার ধাপগুলো দেওয়া আছে।
...
আমরা এই কোর্সের জন্য [**GitHub মডেল**](https://github.com/marketplace?type=models) ব্যবহার করার পরামর্শ দিচ্ছি কারণ এটি:
...
5. প্রম্পট এলে **Reopen in Container** ক্লিক করুন (বা `Ctrl+Shift+P` → "Dev Containers: Reopen in Container" ব্যবহার করুন)
...
> **প্রো টিপ**: যদি আপনার কম স্পেসিফিকেশন মেশিন থাকে কিন্তু লোকাল VS Code ব্যবহার করতে চান, GitHub Codespaces ব্যবহার করুন! আপনি আপনার লোকাল VS Code-কে ক্লাউড-হোস্টেড Codespace-এর সাথে সংযুক্ত করতে পারেন।
...
2. বাম সাইডবারে **Developer settings** ক্লিক করুন (সাধারণত নিচে থাকে)।
3. **Personal access tokens** এর অধীনে **Fine-grained tokens** ক্লিক করুন (বা এই [লিঙ্ক](https://github.com/settings/personal-access-tokens) অনুসরণ করুন)।
...
8. "Repository access" এর অধীনে আপনি যে রিপোজিটরি GitHub মডেলের সাথে ব্যবহার করতে চান তা নির্বাচন করুন (যদি প্রয়োজন হয় তবে "All repositories")।
9. "Repository permissions" এর অধীনে **Models** খুঁজুন এবং এটি **Read and write** এ সেট করুন।
10. **Generate token** ক্লিক করুন।
11. **এখনই আপনার টোকেন কপি এবং সংরক্ষণ করুন** – এটি পরে আর দেখতে পারবেন না!
...
আপনার ডেভেলপমেন্ট এনভায়রনমেন্ট প্রস্তুত হলে, আমাদের উদাহরণ অ্যাপ্লিকেশনটি [`02-SetupDevEnvironment/src/github-models`](../../../02-SetupDevEnvironment/src/github-models) এ GitHub মডেল ইন্টিগ্রেশন পরীক্ষা করুন।
...
প্রথমে, আমরা যা চালিয়েছি তা বুঝি। `src/github-models` এর অধীনে উদাহরণটি OpenAI Java SDK ব্যবহার করে GitHub মডেলের সাথে সংযোগ স্থাপন করে:
...
সমস্যা হচ্ছে? এখানে সাধারণ সমস্যাগুলো এবং সমাধান দেওয়া হলো:
...
- **টোকেন কাজ করছে না?** 
  ...
  - আপনার টোকেনের সঠিক অনুমতি আছে কিনা (Models: Read and write) নিশ্চিত করুন

- **Maven পাওয়া যাচ্ছে না?** 
  - যদি আপনি ডেভ কন্টেইনার/Codespaces ব্যবহার করেন, Maven প্রি-ইনস্টল করা থাকবে
  - লোকাল সেটআপের জন্য, নিশ্চিত করুন Java 21+ এবং Maven 3.9+ ইনস্টল করা আছে
  - `mvn --version` ব্যবহার করে ইনস্টলেশন যাচাই করুন
...
- **ডেভ কন্টেইনার শুরু হচ্ছে না?** 
  - নিশ্চিত করুন Docker Desktop চালু আছে (লোকাল ডেভেলপমেন্টের জন্য)
  - কন্টেইনারটি পুনরায় তৈরি করার চেষ্টা করুন: `Ctrl+Shift+P` → "Dev Containers: Rebuild Container"

- **অ্যাপ্লিকেশন কম্পাইলেশন ত্রুটি?**
  - নিশ্চিত করুন আপনি সঠিক ডিরেক্টরিতে আছেন: `02-SetupDevEnvironment/src/github-models`
  - ক্লিন এবং পুনরায় কম্পাইল করার চেষ্টা করুন: `mvn clean compile`

> **সাহায্য দরকার?**: এখনও সমস্যা হচ্ছে? রিপোজিটরিতে একটি ইস্যু খুলুন এবং আমরা আপনাকে সাহায্য করব।
