...
![شکل: انواع مدل‌های هوش مصنوعی مولد و موارد استفاده.](../../../translated_images/fa/llms.225ca2b8a0d34473.png)
...
![شکل: تعبیه‌ها](../../../translated_images/fa/embedding.398e50802c0037f9.png)
...
![شکل: معماری پایگاه داده برداری که نشان می‌دهد چگونه تعبیه‌ها برای جستجوی شباهت ذخیره و بازیابی می‌شوند.](../../../translated_images/fa/vector.f12f114934e223df.png)
...
![شکل: چگونه یک درخواست به پاسخ تبدیل می‌شود—توکن‌ها، بردارها، جستجوی اختیاری RAG، تفکر LLM و یک عامل MCP همه در یک جریان سریع.](../../../translated_images/fa/flow.f4ef62c3052d12a8.png)
