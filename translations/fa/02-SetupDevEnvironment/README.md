...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-27T12:52:12+00:00",
...
- انتخاب و پیکربندی محیط توسعه مورد نظر خود (اولویت با فضای ابری و Codespaces، کانتینر محلی، یا تنظیم کامل محلی)
...
۱. این مخزن را به حساب GitHub خود فورک کنید  
   > **توجه**: اگر می‌خواهید تنظیمات پایه را ویرایش کنید، لطفاً به [پیکربندی کانتینر توسعه](../../../.devcontainer/devcontainer.json) نگاهی بیندازید.
۲. روی **Code** → تب **Codespaces** → **...** → **New with options...** کلیک کنید.
۳. از تنظیمات پیش‌فرض استفاده کنید – این تنظیمات کانتینر توسعه **Generative AI Java Development Environment** را انتخاب می‌کند که برای این دوره ایجاد شده است.
۴. روی **Create codespace** کلیک کنید.
۵. حدود ۲ دقیقه صبر کنید تا محیط آماده شود.
۶. به [مرحله ۲: ایجاد توکن GitHub](../../../02-SetupDevEnvironment) بروید.
...
**برای توسعه‌دهندگانی که ترجیح می‌دهند با Docker به صورت محلی کار کنند**

۱. این مخزن را به ماشین محلی خود فورک و کلون کنید  
   > **توجه**: اگر می‌خواهید تنظیمات پایه را ویرایش کنید، لطفاً به [پیکربندی کانتینر توسعه](../../../.devcontainer/devcontainer.json) نگاهی بیندازید.
...
۵. وقتی درخواست شد، روی **Reopen in Container** کلیک کنید (یا از `Ctrl+Shift+P` → "Dev Containers: Reopen in Container" استفاده کنید).
۶. منتظر بمانید تا کانتینر ساخته و شروع شود.
۷. به [مرحله ۲: ایجاد توکن GitHub](../../../02-SetupDevEnvironment) بروید.
...
مراحل:
۱. این مخزن را به ماشین محلی خود کلون کنید.
۲. پروژه را در IDE خود باز کنید.
۳. به [مرحله ۲: ایجاد توکن GitHub](../../../02-SetupDevEnvironment) بروید.
...
۱. به [تنظیمات GitHub](https://github.com/settings/profile) بروید و از منوی پروفایل خود **Settings** را انتخاب کنید.
۲. در نوار کناری سمت چپ، روی **Developer settings** کلیک کنید (معمولاً در پایین).
۳. زیر **Personal access tokens**، روی **Fine-grained tokens** کلیک کنید (یا از این [لینک مستقیم](https://github.com/settings/personal-access-tokens) استفاده کنید).
۴. روی **Generate new token** کلیک کنید.
۵. در قسمت "Token name"، یک نام توصیفی وارد کنید (مثلاً `GenAI-Java-Course-Token`).
۶. تاریخ انقضا تنظیم کنید (توصیه‌شده: ۷ روز برای بهترین شیوه‌های امنیتی).
۷. در قسمت "Resource owner"، حساب کاربری خود را انتخاب کنید.
۸. در قسمت "Repository access"، مخازنی که می‌خواهید با مدل‌های GitHub استفاده کنید را انتخاب کنید (یا "All repositories" در صورت نیاز).
۹. در قسمت "Repository permissions"، گزینه **Models** را پیدا کرده و آن را روی **Read and write** تنظیم کنید.
۱۰. روی **Generate token** کلیک کنید.
۱۱. **توکن خود را همین حالا کپی و ذخیره کنید** – دیگر نمی‌توانید آن را ببینید!
...
۲. به مثال مدل‌های GitHub بروید:
   ```bash
   cd 02-SetupDevEnvironment/examples/github-models
   ```
۳. توکن GitHub خود را به عنوان یک متغیر محیطی تنظیم کنید:
   ```bash
   # macOS/Linux
...
- **یکپارچگی را آزمایش کردید** با یک برنامه مثال که با مدل‌های هوش مصنوعی ارتباط برقرار می‌کند
...
- **مشکلات اتصال؟**  
  ...
  - مطمئن شوید که GitHub از شبکه شما قابل دسترسی است.
  - اطمینان حاصل کنید که پشت فایروالی نیستید که نقطه پایانی مدل‌های GitHub را مسدود می‌کند.
