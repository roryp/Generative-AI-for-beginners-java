...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T09:50:56+00:00",
...
**زمان مورد نیاز**: کل کارگاه به صورت آنلاین و بدون نیاز به راه‌اندازی محلی قابل انجام است. راه‌اندازی محیط ۲ دقیقه طول می‌کشد و بررسی نمونه‌ها بسته به عمق کاوش بین ۱ تا ۳ ساعت زمان می‌برد.

> **شروع سریع**

1. این مخزن را به حساب گیت‌هاب خود فورک کنید
2. روی **Code** کلیک کنید → تب **Codespaces** → **...** → **New with options...**
3. از تنظیمات پیش‌فرض استفاده کنید – این تنظیمات کانتینر توسعه ایجاد شده برای این دوره را انتخاب می‌کند
...
- **اکوسیستم هوش مصنوعی جاوا**: مرور کلی Spring AI و OpenAI SDKها
...
- **پیکربندی چند ارائه‌دهنده**: راه‌اندازی GitHub Models، Azure OpenAI و ادغام‌های OpenAI Java SDK
...
- **تولید افزوده بازیابی (RAG)**: ترکیب هوش مصنوعی با منابع داده خودتان
...
- **ایمنی GitHub Models**: آزمایش فیلتر محتوا و مکانیزم‌های ایمنی داخلی (مسدودسازی سخت و رد نرم)
...
اگر گیر کردید یا سوالی درباره ساخت برنامه‌های هوش مصنوعی دارید، به همراه دیگر یادگیرندگان و توسعه‌دهندگان باتجربه در بحث‌های MCP شرکت کنید. این یک جامعه حمایتی است که سوالات پذیرفته می‌شود و دانش به‌صورت آزاد به اشتراک گذاشته می‌شود.
