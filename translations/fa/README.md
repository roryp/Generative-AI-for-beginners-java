...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-29T08:09:00+00:00",
...
- **مفاهیم اصلی**: آشنایی با مدل‌های زبانی بزرگ، توکن‌ها، بردارها و قابلیت‌های هوش مصنوعی
...
- **مهندسی درخواست (Prompt Engineering)**: تکنیک‌هایی برای دریافت پاسخ‌های بهینه از مدل‌های هوش مصنوعی
- **بردارها و عملیات برداری**: پیاده‌سازی جستجوی معنایی و تطبیق شباهت
- **تولید بازیابی-محور (RAG)**: ترکیب هوش مصنوعی با منابع داده خودتان
...
- **دموی هوش مصنوعی مسئولانه**: مثال عملی از نحوه عملکرد سیستم‌های ایمنی مدرن هوش مصنوعی
