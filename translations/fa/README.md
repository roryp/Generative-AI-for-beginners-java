...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-01T08:17:03+00:00",
...
- **تعبیه‌ها و عملیات برداری**: پیاده‌سازی جستجوی معنایی و تطابق شباهت
...
اگر در ساخت برنامه‌های هوش مصنوعی گیر کردید یا سوالی دارید، به بحث‌های MCP بپیوندید. این یک جامعه حمایتی است که در آن سوالات پذیرفته می‌شوند و دانش به صورت آزادانه به اشتراک گذاشته می‌شود.
