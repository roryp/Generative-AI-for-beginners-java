...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-17T13:46:39+00:00",
...
**زمان مورد نیاز**: کل کارگاه می‌تواند به صورت آنلاین و بدون نیاز به راه‌اندازی محلی انجام شود. راه‌اندازی محیط ۲ دقیقه طول می‌کشد و بررسی نمونه‌ها بسته به عمق کاوش بین ۱ تا ۳ ساعت زمان می‌برد.
...
- **پیکربندی چند ارائه‌دهنده**: راه‌اندازی GitHub Models، Azure OpenAI و ادغام OpenAI Java SDK
...
اگر گیر کردید یا سوالی درباره ساخت برنامه‌های هوش مصنوعی دارید، به همراه دیگر یادگیرندگان و توسعه‌دهندگان باتجربه در بحث‌های MCP بپیوندید. این یک جامعه حمایتی است که در آن سوالات پذیرفته می‌شود و دانش به‌صورت آزادانه به اشتراک گذاشته می‌شود.
