...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-18T09:37:16+00:00",
...
3. از تنظیمات پیش‌فرض استفاده کنید – این کار کانتینر توسعه ایجاد شده برای این دوره را انتخاب می‌کند
...
اگر گیر کردید یا سوالی درباره ساخت برنامه‌های هوش مصنوعی دارید، به همراه دیگر یادگیرندگان و توسعه‌دهندگان باتجربه در بحث‌های MCP بپیوندید. این یک جامعه حمایتی است که سوالات در آن خوش‌آمد گفته می‌شود و دانش به‌صورت آزادانه به اشتراک گذاشته می‌شود.
