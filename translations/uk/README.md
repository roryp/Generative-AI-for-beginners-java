...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-25T10:18:11+00:00",
...
**Часові витрати**: Увесь воркшоп можна пройти онлайн без локального налаштування. Якщо ви хочете запустити приклади, налаштування середовища займає 2 хвилини, а дослідження прикладів потребує 1-3 години залежно від глибини дослідження.
...
6. Перейдіть прямо до [Створення токена GitHub Models](./02-SetupDevEnvironment/README.md#step-2-create-a-github-personal-access-token)
...
- **Практичні застосування**: Реальні сценарії, включаючи чатботів та генерацію контенту
