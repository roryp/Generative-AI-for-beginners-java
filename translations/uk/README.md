# Генеративний ШІ для Початківців - Випуск для Java
[![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)

![Генеративний ШІ для Початківців - Випуск для Java](../../translated_images/uk/beg-genai-series.8b48be9951cc574c.webp)

**Час на вивчення**: Весь майстер-клас можна пройти онлайн без локального налаштування. Налаштування середовища займає 2 хвилини, а вивчення прикладів потребує від 1 до 3 годин залежно від глибини вивчення.
...
5. Почекайте приблизно 2 хвилини, щоб середовище було готове
...
- **Основні поняття**: Розуміння великих мовних моделей, токенів, вбудов і можливостей ШІ
- **Екосистема ШІ на Java**: Огляд Spring AI та OpenAI SDK
- **Протокол контексту моделі**: Вступ до MCP та його роль у комунікації AI-агентів
- **Практичні застосування**: Сценарії використання, включаючи чат-ботів і генерацію контенту
- **[→ Почати Розділ 1](./01-IntroToGenAI/README.md)**

### **Розділ 2: Налаштування середовища розробки**
- **Конфігурація з кількома провайдерами**: Налаштування GitHub Models, Azure OpenAI та OpenAI Java SDK інтеграцій
...
- **Вбудови та векторні операції**: Реалізація семантичного пошуку та порівняння схожості
- **Retrieval-Augmented Generation (RAG)**: Поєднання ШІ з власними джерелами даних
- **Виклик функцій**: Розширення можливостей ШІ власними інструментами та плагінами
...
- **Локальна демо Foundry** (`foundrylocal/`): Локальна інтеграція моделі ШІ з OpenAI Java SDK
...
- **Безпека GitHub Models**: Тестування вбудованих механізмів фільтрації контенту та безпеки (жорсткі блокування і м’які відмови)
...
Якщо ви застрягли або маєте питання щодо створення AI-додатків. Приєднуйтесь до інших учнів та досвідчених розробників у обговореннях про MCP. Це підтримуюча спільнота, де вітаються питання і знання вільно діляться.
