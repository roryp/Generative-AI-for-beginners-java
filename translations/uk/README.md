...
**Час, необхідний для проходження**: Весь курс можна пройти онлайн без локального налаштування. Налаштування середовища займає 2 хвилини, а вивчення прикладів — від 1 до 3 годин залежно від глибини дослідження.
...
6. Одразу переходьте до [Першого прикладу](./02-SetupDevEnvironment/README.md#step-2-create-a-github-personal-access-token)
...
- **Основні Концепції**: Розуміння великих мовних моделей, токенів, embeddings та можливостей ШІ
- **Екосистема AI для Java**: Огляд Spring AI та OpenAI SDK
- **Протокол Контексту Моделі**: Вступ до MCP та його роль у спілкуванні AI-агентів
- **Практичні Застосування**: Реальні сценарії, включаючи чат-боти та генерацію контенту
- **[→ Почати Розділ 1](./01-IntroToGenAI/README.md)**

### **Розділ 2: Налаштування Навколишнього Середовища Розробки**
- **Конфігурація для Багатьох Провайдерів**: Налаштування GitHub Models, Azure OpenAI та інтеграцій OpenAI Java SDK
- **Spring Boot + Spring AI**: Кращі практики для розвитку корпоративних AI-додатків
- **GitHub Models**: Безкоштовний доступ до AI-моделей для прототипування та навчання (без необхідності кредитної картки)
- **Інструменти Розробника**: Конфігурації Docker-контейнерів, VS Code та GitHub Codespaces
- **[→ Почати Розділ 2](./02-SetupDevEnvironment/README.md)**

### **Розділ 3: Основні Техніки Генеративного ШІ**
- **Інженерія Запитів (Prompt Engineering)**: Техніки для оптимальних відповідей AI-моделі
- **Embeddings та Векторні Операції**: Реалізація семантичного пошуку та порівняння схожості
...
- **Локальна Демо Foundry** (`foundrylocal/`): Локальна інтеграція AI-моделі за допомогою OpenAI Java SDK
...
Якщо ви застрягли або маєте запитання щодо створення AI-додатків. Приєднуйтеся до інших учнів та досвідчених розробників у обговореннях про MCP. Це підтримуюча спільнота, де вітаються запитання і знання вільно обмінюються.
