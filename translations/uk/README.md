...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T10:46:08+00:00",
...
![Генеративний ШІ для Початківців - Java Версія](../../translated_images/beg-genai-series.8b48be9951cc574c25f8a3accba949bfd03c2f008e2c613283a1b47316fbee68.uk.png)
...
- **Основні поняття**: Розуміння великих мовних моделей, токенів, вбудов та можливостей ШІ
...
- **Вбудови та векторні операції**: Реалізація семантичного пошуку та пошуку за схожістю
