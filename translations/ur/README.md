...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-24T08:59:11+00:00",
...
![ابتدائی افراد کے لیے جنریٹو AI - جاوا ایڈیشن](../../translated_images/beg-genai-series.8b48be9951cc574c25f8a3accba949bfd03c2f008e2c613283a1b47316fbee68.ur.png)

**وقت کی ضرورت**: یہ مکمل ورکشاپ آن لائن مکمل کی جا سکتی ہے بغیر کسی مقامی سیٹ اپ کے۔ ماحول کی ترتیب میں 2 منٹ لگتے ہیں، جبکہ نمونوں کو دریافت کرنے میں 1-3 گھنٹے لگ سکتے ہیں، یہ دریافت کی گہرائی پر منحصر ہے۔
...
- **ماڈل کانٹیکسٹ پروٹوکول**: MCP اور AI ایجنٹ کمیونیکیشن میں اس کا کردار
...
- **ریٹریول-اگمینٹڈ جنریشن (RAG)**: AI کو اپنے ڈیٹا ذرائع کے ساتھ جوڑیں
- **فنکشن کالنگ**: کسٹم ٹولز اور پلگ انز کے ساتھ AI کی صلاحیتوں کو بڑھائیں
...
- **Foundry لوکل ڈیمو** (`foundrylocal/`): OpenAI Java SDK کے ساتھ لوکل AI ماڈل انٹیگریشن
...
- **ذمہ دار AI ڈیمو**: عملی مثال دکھاتی ہے کہ جدید AI سیفٹی سسٹمز کیسے کام کرتے ہیں
- **بہترین طریقے**: اخلاقی AI ڈیولپمنٹ اور تعیناتی کے لیے ضروری رہنما اصول
