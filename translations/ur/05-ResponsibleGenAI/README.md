...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-27T08:34:43+00:00",
...
- **سادہ جیل بریکس**: حفاظتی گارڈریل کو بائی پاس کرنے کی بنیادی کوششوں کو روکتا ہے  
...
1. GitHub Models کلائنٹ کو تصدیق کے ساتھ انیشیئلائز کریں  
2. نقصان دہ پرامپٹس (تشدد، نفرت انگیز تقریر، غلط معلومات، غیر قانونی مواد) کو ٹیسٹ کریں  
3. ہر پرامپٹ کو GitHub Models API پر بھیجیں  
4. ردعمل کو ہینڈل کریں: یا تو جنریٹڈ مواد یا حفاظتی فلٹر بلاکس  
5. نتائج دکھائیں کہ کون سا مواد بلاک ہوا اور کون سا اجازت دی گئی  
...
- **محفوظ مواد** جو نارمل ردعمل حاصل کرتا ہے  
- **نقصان دہ مواد** جو حفاظتی فلٹرز کے ذریعے بلاک ہوتا ہے  
...
1. **ہمیشہ حفاظتی فلٹر کے ممکنہ ردعمل کو خوش اسلوبی سے ہینڈل کریں**  
...
3. **صارفین کو ذمہ دار اے آئی کے استعمال کے بارے میں تعلیم دیں**  
   - قابل قبول استعمال پر واضح رہنما اصول فراہم کریں  
   - وضاحت کریں کہ کیوں کچھ مواد بلاک کیا جا سکتا ہے  

4. **حفاظتی واقعات کی نگرانی اور لاگنگ کریں**  
...
5. **پلیٹ فارم کی مواد کی پالیسیوں کا احترام کریں**  
   - پلیٹ فارم کے رہنما اصولوں سے اپ ڈیٹ رہیں  
...
- **ذمہ دار اے آئی ترقی اور تعیناتی کے بہترین طریقے سیکھے**  

**ذمہ دار اے آئی وسائل:**  
- [Microsoft Trust Center](https://www.microsoft.com/trust-center) - سیکیورٹی، پرائیویسی، اور کمپلائنس کے لیے مائیکروسافٹ کا نقطہ نظر سیکھیں  
...
جنریٹو اے آئی فار بیگنرز کورس مکمل کرنے پر مبارک ہو! آپ کے پاس اب علم اور اوزار موجود ہیں تاکہ ذمہ دار اور مؤثر جنریٹو اے آئی ایپلیکیشنز جاوا کے ساتھ بنائی جا سکیں۔

![کورس مکمل کرنا](../../../translated_images/image.73c7e2ff4a652e77a3ff439639bf47b8406e3b32ec6ecddc571a31b6f886cf12.ur.png)
