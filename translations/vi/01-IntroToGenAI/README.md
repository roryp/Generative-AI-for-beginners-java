...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-29T09:43:00+00:00",
...
![Hình: Các loại mô hình Generative AI và các trường hợp sử dụng.](../../../translated_images/vi/llms.225ca2b8a0d34473.png)
...
![Hình: Embeddings](../../../translated_images/vi/embedding.398e50802c0037f9.png)
...
![Hình: Kiến trúc cơ sở dữ liệu vector, hiển thị cách embeddings được lưu trữ và truy xuất để tìm kiếm tương tự.](../../../translated_images/vi/vector.f12f114934e223df.png)
...
![Hình: cách một prompt trở thành phản hồi—tokens, vectors, tra cứu RAG tùy chọn, suy nghĩ của LLM, và một agent MCP tất cả trong một luồng nhanh chóng.](../../../translated_images/vi/flow.f4ef62c3052d12a8.png)
