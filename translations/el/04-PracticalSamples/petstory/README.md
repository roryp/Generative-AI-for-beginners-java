...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-25T09:32:25+00:00",
...
Μια web εφαρμογή Spring Boot που δημιουργεί περιγραφές και ιστορίες με τη βοήθεια AI για εικόνες κατοικίδιων που ανεβάζετε, χρησιμοποιώντας GitHub Models.

## Πίνακας Περιεχομένων

- [Τεχνολογικό Στοίβαγμα](../../../../04-PracticalSamples/petstory)
...
- Maven 3.9+
- GitHub Personal Access Token με δικαιώματα `models:read`

## Ρύθμιση & Εγκατάσταση

### 1. Μεταβείτε στον κατάλογο της εφαρμογής petstory
```bash
...
1. **Πρόσβαση στην Εφαρμογή**: Μεταβείτε στο `http://localhost:8080`
