...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-23T12:18:18+00:00",
...
> **Γρήγορη Έναρξη**: Κώδικας στο Cloud σε 2 λεπτά - Μεταβείτε στη [Ρύθμιση GitHub Codespaces](../../../02-SetupDevEnvironment) - δεν απαιτείται τοπική εγκατάσταση και χρησιμοποιεί μοντέλα του GitHub!
...
- [Βήμα 1: Ρύθμιση του Περιβάλλοντος Ανάπτυξης](../../../02-SetupDevEnvironment)
  ...
  - [Επιλογή Γ: Χρήση της Υπάρχουσας Τοπικής Εγκατάστασης](../../../02-SetupDevEnvironment)
...
#### Επιλογή Γ: Χρήση της Υπάρχουσας Τοπικής Εγκατάστασης
...
1. Ανοίξτε το terminal στο περιβάλλον ανάπτυξης σας.
...
Αρχικά, ας κατανοήσουμε τι μόλις εκτελέσαμε. Το παράδειγμα στο `src/github-models` χρησιμοποιεί το OpenAI Java SDK για να συνδεθεί με τα GitHub Models:
...
- **Δεν βρέθηκε Maven;** 
  ...
  - Για τοπική ρύθμιση, βεβαιωθείτε ότι το Java 21+ και το Maven 3.9+ είναι εγκατεστημένα
...
- **Το dev container δεν ξεκινά;** 
  - Βεβαιωθείτε ότι το Docker Desktop είναι ενεργοποιημένο (για τοπική ανάπτυξη)
