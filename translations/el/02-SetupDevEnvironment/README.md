...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-27T13:09:38+00:00",
...
Αυτό το κεφάλαιο θα σας καθοδηγήσει στη ρύθμιση του περιβάλλοντος ανάπτυξης. Θα χρησιμοποιήσουμε τα **GitHub Models** ως κύριο παράδειγμα, επειδή είναι δωρεάν, εύκολο στη ρύθμιση με έναν λογαριασμό GitHub, δεν απαιτεί πιστωτική κάρτα και παρέχει πρόσβαση σε πολλαπλά μοντέλα για πειραματισμό.
...
> 
> Για χρήση σε παραγωγή, αναβαθμίστε στα Azure AI Foundry Models με τον λογαριασμό σας στο Azure. Ο κώδικάς σας δεν χρειάζεται να αλλάξει. Δείτε την [τεκμηρίωση Azure AI Foundry](https://learn.microsoft.com/azure/ai-foundry/foundry-models/how-to/quickstart-github-models).
...
> **Συμβουλή Ασφαλείας**: Χρησιμοποιήστε το ελάχιστο απαιτούμενο scope και τη συντομότερη δυνατή διάρκεια λήξης για τα tokens πρόσβασης.

## Βήμα 3: Δοκιμή της Ρύθμισης με το Παράδειγμα GitHub Models

Μόλις το περιβάλλον ανάπτυξης είναι έτοιμο, ας δοκιμάσουμε την ενσωμάτωση των GitHub Models με την εφαρμογή παραδείγματος μας στο [`02-SetupDevEnvironment/examples/github-models`](../../../02-SetupDevEnvironment/examples/github-models).
...
Αρχικά, ας κατανοήσουμε τι μόλις εκτελέσαμε. Το παράδειγμα στο `examples/github-models` χρησιμοποιεί το OpenAI Java SDK για να συνδεθεί με τα GitHub Models:
...
Έχετε προβλήματα; Ακολουθούν κοινά προβλήματα και λύσεις:
...
> **Χρειάζεστε βοήθεια;**: Εξακολουθείτε να έχετε προβλήματα; Ανοίξτε ένα ζήτημα στο repository και θα σας βοηθήσουμε.
