...
![Εικόνα: Τύποι μοντέλων γενεσιουργού AI και περιπτώσεις χρήσης.](../../../translated_images/llms.225ca2b8a0d34473.el.png)
...
![Εικόνα: Embeddings](../../../translated_images/embedding.398e50802c0037f9.el.png)
...
![Εικόνα: Αρχιτεκτονική βάσης δεδομένων διανυσμάτων που δείχνει πώς αποθηκεύονται και ανακτώνται τα embeddings για αναζήτηση ομοιότητας.](../../../translated_images/vector.f12f114934e223df.el.png)
...
![Εικόνα: πώς μια προτροπή γίνεται απάντηση—tokens, διανύσματα, προαιρετική αναζήτηση RAG, σκέψη LLM και πράκτορας MCP όλα σε μία γρήγορη ροή.](../../../translated_images/flow.f4ef62c3052d12a8.el.png)
