...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T17:26:42+00:00",
...
**זמן נדרש**: ניתן להשלים את הסדנה כולה באופן מקוון ללא צורך בהתקנה מקומית. הגדרת הסביבה אורכת 2 דקות, והדוגמאות דורשות 1-3 שעות בהתאם לעומק החקירה.
...
- **דמו מקומי של Foundry** (`foundrylocal/`): שילוב מודל AI מקומי עם SDK של OpenAI ב-Java
...
אם אתם נתקעים או יש לכם שאלות לגבי בניית אפליקציות AI, הצטרפו ללומדים אחרים ולמפתחים מנוסים לדיונים על MCP. זו קהילה תומכת שבה שאלות מתקבלות בברכה וידע משותף בחופשיות.
