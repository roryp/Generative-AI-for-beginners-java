...
**Tempo richiesto**: L'intero workshop può essere completato online senza installazioni locali. La configurazione dell'ambiente richiede 2 minuti, mentre l'esplorazione degli esempi richiede da 1 a 3 ore a seconda della profondità di esplorazione.
...
- **Concetti Fondamentali**: Comprendere i Large Language Models, token, embeddings e capacità AI
- **Ecosistema AI Java**: Panoramica di Spring AI e SDK OpenAI
- **Protocollo Contesto Modello**: Introduzione a MCP e il suo ruolo nella comunicazione degli agenti AI
...
### **Capitolo 2: Configurazione Ambiente di Sviluppo**
- **Configurazione Multi-Provider**: Setup di GitHub Models, Azure OpenAI e integrazioni OpenAI Java SDK
- **Spring Boot + Spring AI**: Best practice per lo sviluppo di applicazioni aziendali AI
...
- **Generazione Arricchita da Recupero (RAG)**: Combina AI con le tue fonti dati
- **Chiamata di Funzioni**: Estendi le capacità AI con strumenti e plugin personalizzati
...
- **Sicurezza GitHub Models**: Testa i filtri integrati di contenuto e i meccanismi di sicurezza (blocchi rigidi e rifiuti soft)
- **Demo AI Responsabile**: Esempio pratico che mostra come funzionano i moderni sistemi di sicurezza AI
- **Best Practice**: Linee guida essenziali per lo sviluppo e il deployment etico dell’AI
